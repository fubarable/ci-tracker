import { i as e, l as t, n, r, t as i } from './Presence-2uTOxF-0.js';
import {
    $t as a,
    At as o,
    F as s,
...
import {
    ...
    s as ce,
    t as le,
} from './button-BzNzzr7Y.js';
import { n as ue, r as de, t as fe } from './check-DzFiyizp.js';
import {
    a as pe,
    i as me,
    n as he,
...
import { i as Ae, n as je, r as Me } from './VisuallyHidden-CkwGWtf9.js';
import {
    a as Ne,
    i as Pe,
    n as Fe,
    o as Ie,
    s as Le,
} from './PopperContent-BrykBjOb.js';
import { t as Re } from './x-dBkW_o3i.js';
import { t as ze } from './VisuallyHiddenInput-Dn2PK-mm.js';
import { i as Be } from './utils-D3Q8CJms.js';
import { t as Ve } from './createLucideIcon-DhBKMkeN.js';
import { t as He } from './chevrons-up-down-BNNc_3XW.js';
import { t as Ue } from './routes--dF3VN8g.js';
import { t as We } from './badge-CN-XfSW9.js';
import './dialog-BsBm-aYI.js';
import { i as Ge, n as Ke, r as qe, t as Je } from './CardTitle-BtDt8CVB.js';
function Ye(e, t, n) {
    let r = e.findIndex((e) => de(e, t)),
        i = e.findIndex((e) => de(e, n));
    if (r === -1 || i === -1) return [];
...
function Ze(e) {
    let t = c(() => F(e)),
        n = c(() => new Intl.Collator(`en`, { usage: `search`, ...t.value }));
    return {
        startsWith: (e, t) =>
            t.length === 0
                ? !0
                : ((e = e.normalize(`NFC`)),
                  (t = t.normalize(`NFC`)),
                  n.value.compare(e.slice(0, t.length), t) === 0),
        endsWith: (e, t) =>
            t.length === 0
                ? !0
                : ((e = e.normalize(`NFC`)),
                  (t = t.normalize(`NFC`)),
                  n.value.compare(e.slice(-t.length), t) === 0),
        contains: (e, t) => {
...
var [tt, nt] = t(`ListboxRoot`),
    rt = O({
        ...
        setup(e, { expose: t, emit: n }) {
            let r = e,
                ...
                { getItems: p } = je({ isProvider: !0 }),
                { handleTypeaheadSearch: m } = Ie(),
                { primitiveElement: h, currentElement: _ } = Me(),
                y = Qe(),
                b = Ae(f),
                S = ue(_),
                C = P(),
            ...
            function O(e) {
                if (((T.value = !0), r.multiple)) {
                    let t = Array.isArray(D.value) ? [...D.value] : [],
                        n = t.findIndex((t) => et(t, e, r.by));
                    r.selectionBehavior === `toggle`
                        ? (n === -1 ? t.push(e) : t.splice(n, 1), (D.value = t))
                        : ((D.value = [e]), (C.value = e));
                } else
                    r.selectionBehavior === `toggle` && et(D.value, e, r.by)
                        ? (D.value = void 0)
                        : (D.value = e);
                setTimeout(() => {
                    T.value = !1;
            ...
            function I(e, t = !0, n) {
                if (!e) return;
                ((k.value = e),
                    (n ?? E.value) && k.value.focus(),
                    t && k.value.scrollIntoView({ block: `nearest` }));
                let r = p().find((t) => t.ref === e);
                i(`highlight`, r);
            }
            function oe(e) {
                if (j.value) re.trigger(e);
                else {
                    let t = p().find((t) => et(t.value, e, r.by));
                    t && ((k.value = t.ref), I(t.ref));
                }
            }
            function se(e) {
                if (k.value && k.value.isConnected) {
                    ...
                    (e.preventDefault(),
                        e.stopPropagation(),
                        te.value || k.value.click());
                }
            }
            function ce(e) {
                if (E.value) {
                    if (((T.value = !0), j.value)) ne.trigger(e);
                    else {
                        let t = e.altKey || e.ctrlKey || e.metaKey;
                        if (t && e.key === `a` && a.value) {
                            let t = p(),
                                n = t.map((e) => e.value);
                            ((D.value = [...n]), e.preventDefault());
                            let r = t.at(-1);
                            r && I(r.ref);
                        } else if (!t) {
                            let t = m(e.key, p());
            ...
            function fe() {
                o(() => {
                    he(new KeyboardEvent(`keydown`, { key: `PageUp` }));
                });
            }
            function pe(e) {
                let t = k.value;
                (t?.isConnected && (A.value = t),
                    (k.value = null),
                    i(`leave`, e));
            }
            function me(e) {
            ...
            function he(e) {
                ...
                if (k.value) {
                    if (t === `last`) n.reverse();
                        ...
                        t === `prev` && n.reverse();
                        let e = n.indexOf(k.value);
                        n = n.slice(e + 1);
                    }
                    ge(e, n[0]);
                }
                if (n.length) {
                    let e = !k.value && t === `prev` ? n.length - 1 : 0;
                    I(n[e]);
                }
                if (j.value) return ne.trigger(e);
            }
            function ge(e, t) {
                if (
                    !(
                        j.value ||
                        r.selectionBehavior !== `replace` ||
                        !a.value ||
                    ...
                    let n = p().filter((e) => e.ref.dataset.disabled !== ``),
                        r = n.find((e) => e.ref === t)?.value;
                    if (
                        (e.key === y.END
                            ? (r = n.at(-1)?.value)
                            : e.key === y.HOME && (r = n[0]?.value),
                        !r || !C.value)
                    )
                        return;
                    let i = Ye(
            ...
            async function _e(e, t = !0) {
                if (Te)
                    if ((await o(), j.value))
                        M.trigger({ event: e, scroll: t });
                    else {
                        let e = ie(),
                            n = e.find((e) => e.dataset.state === `checked`),
                            r = t ? void 0 : !1;
                        n ? I(n, t, r) : e.length && I(e[0], t, r);
                    }
            }
            let ve = !1;
            return (
                ...
                (e, t) => (
                    ...
                    N(
                        ...
                        {
                            default: g(() => [
                                x(e.$slots, `default`, { modelValue: F(D) }),
                                F(S) && e.name
                                    ? (v(),
                                      N(
                                          F(ze),
                    ...
                    default: g(() => [
                        M(
                            F(ae),
                            {
                                ...
                                as: e.as,
                                'as-child': e.asChild,
                                tabindex: F(n).focusable.value
                                    ? F(n).highlightedElement.value
                                        ? `-1`
                                        : `0`
                                    : `-1`,
                                'aria-orientation': F(n).orientation.value,
                                'aria-multiselectable': !!F(n).multiple.value,
                                ...
                                onKeydown: [
                                    ...
                                    m(F(n).onKeydownEnter, [`enter`]),
                                    F(n).onKeydownTypeAhead,
                                ],
                            },
                            {
                                default: g(() => [x(e.$slots, `default`)]),
                                _: 3,
                            },
                            8,
                            [
    ...
    at = O({
        ...
        setup(e, { emit: t }) {
            let n = e,
                ...
                i = tt(),
                { primitiveElement: a, currentElement: o } = Me(),
                s = c(() => n.disabled || i.disabled.value || !1),
                l = P();
            (T(() => (l.value = i.highlightedElement.value?.id)),
                p(() => {
                    ((i.focusable.value = !1),
                        setTimeout(() => {
            ...
            function h() {
                (i.onCompositionStart(), d());
            }
            function _(e) {
                u.value || ((r.value = e.target.value), i.highlightFirstItem());
            }
            function b(e) {
                u.value || (e.preventDefault(), i.onKeydownNavigation(e));
            }
            function S(e) {
                u.value || i.onKeydownEnter(e);
            }
            return (e, t) => (
                v(),
                N(
                    F(ae),
                    {
                        ...
                        type: `text`,
                        onKeydown: [
                            m(b, [`down`, `up`, `home`, `end`]),
                            m(S, [`enter`]),
                        ],
                        onInput: _,
                        onCompositionstart: h,
                        onCompositionend: F(f),
                    },
                    {
                        default: g(() => [
                            x(e.$slots, `default`, { modelValue: F(r) }),
                        ]),
                        _: 3,
                    },
                    8,
        ...
        setup(e) {
            ...
            return (
                ...
                (e, n) => (
                    ...
                    N(
                        F(ae),
                        A({ role: `group` }, t, { 'aria-labelledby': F(r) }),
                        { default: g(() => [x(e.$slots, `default`)]), _: 3 },
                        16,
                        [`aria-labelledby`],
                    )
                )
    ...
    pt = O({
        ...
        setup(e, { emit: t }) {
            let r = e,
                i = t,
                a = n(void 0, `reka-listbox-item`),
                { CollectionItem: o } = je(),
                { forwardRef: s, currentElement: l } = ke(),
                u = tt(),
                d = c(
                    () =>
                        l.value != null &&
                        l.value === u.highlightedElement.value,
                ),
                f = c(() => $e(u.modelValue.value, r.value, u.by)),
                p = c(() => u.disabled.value || r.disabled);
            async function h(e) {
                (i(`select`, e),
                    !e?.defaultPrevented &&
                        !p.value &&
                        e &&
                        (u.onValueChange(r.value), u.changeHighlight(l.value)));
            }
            function y(e) {
                be(ut, h, { originalEvent: e, value: r.value });
            }
            return (
                ft({ isSelected: f }),
                (e, t) => (
                                    ...
                                    () =>
                                        M(
                                            ...
                                            A({ id: F(a) }, e.$attrs, {
                                                ...
                                                onPointermove: (t[0] ||= () => {
                                                    F(u).highlightedElement
                                                        .value !== F(l) &&
                                                        F(u).highlightOnHover
                                                            .value &&
                                                        F(u).changeHighlight(
                                                            F(l),
                                                            !1,
    ...
    _t = O({
        ...
        props: {
            ...
            memoDependencies: { type: Array, required: !1 },
        ...
        setup(t, { emit: n }) {
            let r = t,
                i = n,
                a = e(Oe(r, `trapFocus`, `disableOutsidePointerEvents`)),
                { forwardRef: o } = ke(),
                s = mt();
            return (
                Le(),
                                ...
                                M(
                                    F(ve),
                                    {
                                        ...
                                        onPointerDownOutside: (t[0] ||= (e) =>
                                            i(`pointerDownOutside`, e)),
                                        onInteractOutside: (t[1] ||= (e) =>
                                            i(`interactOutside`, e)),
                                        onEscapeKeyDown: (t[2] ||= (e) =>
                                            i(`escapeKeyDown`, e)),
                                        onFocusOutside: (t[3] ||= (e) =>
                                            i(`focusOutside`, e)),
                                        onDismiss: (t[4] ||= (e) =>
                                            F(s).onOpenChange(!1)),
                                    },
    ...
    vt = O({
        ...
        setup(e, { emit: t }) {
            ...
            xe(!0);
            let s = r(n, i),
                { forwardRef: c, currentElement: l } = ke();
            return (
                ye(l),
                (e, t) => (
                    v(),
                    N(
                        ...
                        A(F(s), {
                            ...
                            'disable-outside-pointer-events': ``,
                            onCloseAutoFocus: (t[0] ||= k(
                                (e) => {
                                    (i(`closeAutoFocus`, e),
                                        o.value ||
                                            F(a).triggerElement.value?.focus());
                                },
                                [`prevent`],
                            )),
                            ...
                            (i(`interactOutside`, e),
                                e.defaultPrevented ||
                                    ...
                                    e.detail.originalEvent.type ===
                                        `pointerdown` && (s.value = !0)));
                            let t = e.target;
                            (F(a).triggerElement.value?.contains(t) &&
                                e.preventDefault(),
    ...
    bt = O({
        ...
        setup(e, { emit: t }) {
            let a = e,
                ...
                { forwardRef: l } = ke();
            return (
                (s.contentId ||= n(void 0, `reka-popover-content`)),
                (e, t) => (
                    v(),
                    N(
                        F(i),
                        { present: e.forceMount || F(s).open.value },
                        {
                            default: g(() => [
                                F(s).modal.value
                                    ? (v(),
    ...
    St = O({
        ...
        setup(e) {
            let t = e,
                r = mt(),
                { forwardRef: i, currentElement: o } = ke();
            return (
                (r.triggerId ||= n(void 0, `reka-popover-trigger`)),
                p(() => {
                ...
                (e, n) => (
                    v(),
                    N(
                        a(F(r).hasCustomAnchor.value ? F(ae) : F(Pe)),
                        { 'as-child': `` },
                        {
                            default: g(() => [
                                M(
                                    F(ae),
                                    {
                                        ...
                                        'aria-expanded': F(r).open.value,
                                        'aria-controls': F(r).contentId,
                                        'data-state': F(r).open.value
                                            ? `open`
                                            : `closed`,
                                        as: e.as,
                                        'as-child': t.asChild,
                                        onClick: F(r).onOpenToggle,
                                    },
                                    {
                                        default: g(() => [
                                            x(e.$slots, `default`),
...
var Tt = (e, t, n) => Math.max(Math.min(e, n), t);
function Et(e) {
    return Tt(wt(e * 2.55), 0, 255);
}
function Dt(e) {
    return Tt(wt(e * 255), 0, 255);
}
function Ot(e) {
    return Tt(wt(e / 2.55) / 100, 0, 1);
}
function kt(e) {
    return Tt(wt(e * 100), 0, 100);
}
var At = {
        0: 0,
        1: 1,
    ...
    jt = [...`0123456789ABCDEF`],
    Mt = (e) => jt[e & 15],
    Nt = (e) => jt[(e & 240) >> 4] + jt[e & 15],
    Pt = (e) => (e & 240) >> 4 == (e & 15),
    Ft = (e) => Pt(e.r) && Pt(e.g) && Pt(e.b) && Pt(e.a);
function It(e) {
    var t = e.length,
        n;
    return (
...
var Lt = (e, t) => (e < 255 ? t(e) : ``);
function Rt(e) {
    var t = Ft(e) ? Mt : Nt;
    return e ? `#` + t(e.r) + t(e.g) + t(e.b) + Lt(e.a, t) : void 0;
}
var zt =
...
function Gt(e, t, n, r) {
    return (Array.isArray(t) ? e(t[0], t[1], t[2]) : e(t, n, r)).map(Dt);
}
function Kt(e, t, n) {
    return Gt(Bt, e, t, n);
}
...
var nn;
function rn(e) {
    nn || ((nn = tn()), (nn.transparent = [0, 0, 0, 0]));
...
function on(e) {
    ...
    if (t) {
        if (t[7] !== r) {
            let e = +t[7];
            n = t[8] ? Et(e) : Tt(e * 255, 0, 255);
        }
        return (
            (r = +t[1]),
            (i = +t[3]),
            (a = +t[5]),
            (r = 255 & (t[2] ? Et(r) : Tt(r, 0, 255))),
            (i = 255 & (t[4] ? Et(i) : Tt(i, 0, 255))),
            (a = 255 & (t[6] ? Et(a) : Tt(a, 0, 255))),
            { r, g: i, b: a, a: n }
        );
    }
}
function sn(e) {
    return (
        e &&
        (e.a < 255
            ? `rgba(${e.r}, ${e.g}, ${e.b}, ${Ot(e.a)})`
            : `rgb(${e.r}, ${e.g}, ${e.b})`)
    );
}
var cn = (e) => (e <= 0.0031308 ? e * 12.92 : e ** (1 / 2.4) * 1.055 - 0.055),
    ln = (e) => (e <= 0.04045 ? e / 12.92 : ((e + 0.055) / 1.055) ** 2.4);
function un(e, t, n) {
    let r = ln(Ot(e.r)),
        i = ln(Ot(e.g)),
        a = ln(Ot(e.b));
    return {
        r: Dt(cn(r + n * (ln(Ot(t.r)) - r))),
        g: Dt(cn(i + n * (ln(Ot(t.g)) - i))),
        b: Dt(cn(a + n * (ln(Ot(t.b)) - a))),
        a: e.a + n * (t.a - e.a),
    };
}
function dn(e, t, n) {
    ...
    return (
        Array.isArray(e)
            ? e.length >= 3 &&
              ...
              e.length > 3 && (t.a = Dt(e[3])))
            : ((t = fn(e, { r: 0, g: 0, b: 0, a: 1 })), (t.a = Dt(t.a))),
        t
    );
}
function mn(e) {
    return e.charAt(0) === `r` ? on(e) : Xt(e);
}
var hn = class e {
    constructor(t) {
    ...
    hexString() {
        return this._valid ? Rt(this._rgb) : void 0;
    }
    hslString() {
    ...
    interpolate(e, t) {
        return (e && (this._rgb = un(this._rgb, e._rgb, t)), this);
    }
    clone() {
    ...
    greyscale() {
        let e = this._rgb;
        return (
            (e.r = e.g = e.b = wt(e.r * 0.3 + e.g * 0.59 + e.b * 0.11)),
            this
        );
    }
    opaquer(e) {
    ...
    lighten(e) {
        return (dn(this._rgb, 2, e), this);
    }
    darken(e) {
        return (dn(this._rgb, 2, -e), this);
    }
    saturate(e) {
        return (dn(this._rgb, 1, e), this);
    }
    desaturate(e) {
        return (dn(this._rgb, 1, -e), this);
    }
    rotate(e) {
        return (Zt(this._rgb, e), this);
    }
};
function gn() {}
var _n = (() => {
...
function bn(e) {
    if (R(e)) return e.map(bn);
    if (z(e)) {
        let t = Object.create(null),
            n = Object.keys(e),
            r = n.length,
            i = 0;
        for (; i < r; ++i) t[n[i]] = bn(e[n[i]]);
        return t;
    }
    return e;
}
...
function Tn(e, t, n) {
    ...
    z(r) && z(i)
        ? wn(r, i)
        : Object.prototype.hasOwnProperty.call(t, e) || (t[e] = bn(i));
}
var En = { '': (e) => e, x: (e) => e.x, y: (e) => e.y };
function Dn(e) {
    let t = e.split(`.`),
        n = [],
        r = ``;
...
function Kn(e) {
    return !Gn(e) && !isNaN(parseFloat(e)) && isFinite(e);
}
function qn(e, t) {
    let n = Math.round(e);
    return n - t <= e && n + t >= e;
...
function Qn(e, t) {
    let n = t.x - e.x,
        ...
        i = Math.sqrt(n * n + r * r),
        a = Math.atan2(r, n);
    return (a < -0.5 * G && (a += K), { angle: a, distance: i });
}
function $n(e, t) {
...
function ir(e) {
    return rr(e, -32768, 32767);
}
function ar(e, t, n, r = 1e-6) {
...
var ur = [`push`, `pop`, `shift`, `splice`, `unshift`];
function dr(e, t) {
    if (e._chartjs) {
...
var _r = (e) => (e === `start` ? `left` : e === `end` ? `right` : `center`),
    J = (e, t, n) => (e === `start` ? t : e === `end` ? n : (t + n) / 2),
    vr = (e, t, n, r) =>
    ...
    if (e._sorted) {
        ...
        if (p) {
            if (
                ((i = Math.min(
                    sr(c, u, d).lo,
                    n ? r : sr(t, u, o.getPixelForValue(d)).lo,
                )),
                l)
            ) {
                let e = c
        ...
        if (m) {
            let e = Math.max(
                sr(c, o.axis, f, !0).hi + 1,
                n ? 0 : sr(t, u, o.getPixelForValue(f), !0).hi + 1,
            );
            if (l) {
                let t = c.slice(e - 1).findIndex((e) => !L(e[s.axis]));
                e += Math.max(0, t);
            }
            a = rr(e, i, r) - i;
        } else a = r - i;
...
var xr = (e) => e === 0 || e === 1,
    Sr = (e, t, n) => -(2 ** (10 * --e) * Math.sin(((e - t) * K) / n)),
    Cr = (e, t, n) => 2 ** (-10 * e) * Math.sin(((e - t) * K) / n) + 1,
    wr = {
        linear: (e) => e,
        easeInQuad: (e) => e * e,
        easeOutQuad: (e) => -e * (e - 2),
        ...
        easeInOutQuint: (e) =>
            (e /= 0.5) < 1
                ? 0.5 * e * e * e * e * e
                : 0.5 * ((e -= 2) * e * e * e * e + 2),
        easeInSine: (e) => -Math.cos(e * q) + 1,
        easeOutSine: (e) => Math.sin(e * q),
        easeInOutSine: (e) => -0.5 * (Math.cos(G * e) - 1),
        ...
        easeInElastic: (e) => (xr(e) ? e : Sr(e, 0.075, 0.3)),
        easeOutElastic: (e) => (xr(e) ? e : Cr(e, 0.075, 0.3)),
        easeInOutElastic(e) {
            let t = 0.1125,
                n = 0.45;
            return xr(e)
...
function Er(e) {
    return Tr(e) ? e : new hn(e);
}
function Dr(e) {
    return Tr(e) ? e : new hn(e).saturate(0.5).darken(0.1).hexString();
}
var Or = [`x`, `y`, `borderWidth`, `radius`, `tension`],
...
function Ar(e) {
    (e.set(`animation`, {
        ...
        e.set(`animations`, {
            ...
            numbers: { type: `number`, properties: Or },
        }),
...
function Nr(e, t) {
    ...
    let n = e + JSON.stringify(t),
        r = Mr.get(n);
    return (r || ((r = new Intl.NumberFormat(e, t)), Mr.set(n, r)), r);
}
function Pr(e, t, n) {
...
var Fr = {
    ...
    numeric(e, t, n) {
        ...
        if (n.length > 1) {
            ...
            ((t < 1e-4 || t > 0x38d7ea4c68000) && (i = `scientific`),
                (a = Ir(e, n)));
        }
        let o = Bn(Math.abs(a)),
        ...
        return (Object.assign(c, this.options.ticks.format), Pr(e, r, c));
    },
    logarithmic(e, t, n) {
        if (e === 0) return `0`;
        let r = n[t].significand || e / 10 ** Math.floor(Bn(e));
        return [1, 2, 3, 5, 10, 15].includes(r) || t > 0.8 * n.length
            ? Fr.numeric.call(this, e, t, n)
            : ``;
    },
};
function Ir(e, t) {
...
function Hr(e, t, n) {
    return typeof t == `string` ? Cn(Vr(e, t), n) : Cn(Vr(e, ``), t);
}
var Y = new (class {
    constructor(e, t) {
        ((this.animation = void 0),
            ...
            (this.hover = {}),
            (this.hoverBackgroundColor = (e, t) => Dr(t.backgroundColor)),
            (this.hoverBorderColor = (e, t) => Dr(t.borderColor)),
            (this.hoverColor = (e, t) => Dr(t.color)),
            (this.indexAxis = `x`),
            (this.interaction = {
                mode: `nearest`,
                intersect: !0,
        ...
        Object.defineProperties(i, {
            ...
            [t]: {
                ...
                get() {
                    let e = this[o],
                        t = a[r];
                    return z(e) ? Object.assign({}, t, e) : H(e, t);
                },
                set(e) {
                    this[o] = e;
                },
...
function Gr(e, t, n, r) {
    ...
    let o = 0,
        ...
        f;
    for (c = 0; c < s; c++)
        if (((d = n[c]), d != null && !R(d))) o = Wr(e, i, a, o, d);
        else if (R(d))
            for (l = 0, u = d.length; l < u; l++)
                ((f = d[l]), f != null && !R(f) && (o = Wr(e, i, a, o, f)));
    e.restore();
    let p = a.length / 2;
    if (p > n.length) {
...
function Yr(e, t, n, r, i) {
    ...
    if (!(isNaN(h) || h <= 0)) {
        switch ((e.beginPath(), p)) {
            default:
                (i ? e.ellipse(n, r, i / 2, h, 0, 0, K) : e.arc(n, r, h, 0, K),
                    e.closePath());
                break;
            case `triangle`:
                ((u = i ? i / 2 : h),
            ...
            case `rectRounded`:
                ((l = h * 0.516),
                    (c = h - l),
                    (o = Math.cos(g + Rn) * c),
                    (d = Math.cos(g + Rn) * (i ? i / 2 - l : c)),
                    (s = Math.sin(g + Rn) * c),
                    (f = Math.sin(g + Rn) * (i ? i / 2 - l : c)),
                    e.arc(n - d, r - s, l, g - G, g - q),
                    e.arc(n + f, r - o, l, g - q, g),
                    e.arc(n + d, r + s, l, g, g + q),
                    e.arc(n - f, r + o, l, g + q, g + G),
                    e.closePath());
                break;
            case `rect`:
                if (!m) {
...
function ti(e, t) {
    (t.translation && e.translate(t.translation[0], t.translation[1]),
        L(t.rotation) || e.rotate(t.rotation),
...
function ii(e, t, n, r, i, a = {}) {
    let o = R(t) ? t : [t],
        ...
        c,
        l;
    for (e.save(), e.font = i.string, ti(e, a), c = 0; c < o.length; ++c)
        ((l = o[c]),
            a.backdrop && ri(e, a.backdrop),
            s &&
                (a.strokeColor && (e.strokeStyle = a.strokeColor),
                L(a.strokeWidth) || (e.lineWidth = a.strokeWidth),
...
function ai(e, t) {
    ...
    (e.arc(n + o.topLeft, r + o.topLeft, o.topLeft, 1.5 * G, G, !0),
        e.lineTo(n, r + a - o.bottomLeft),
        e.arc(n + o.bottomLeft, r + a - o.bottomLeft, o.bottomLeft, G, q, !0),
        ...
        e.arc(n + i - o.topRight, r + o.topRight, o.topRight, 0, -q, !0),
        e.lineTo(n + o.topLeft, r));
}
var oi = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
    si =
...
function ui(e, t) {
    let n = {},
        r = z(t),
        i = r ? Object.keys(t) : t,
        a = z(e) ? (r ? (n) => H(e[n], e[t[n]]) : (t) => e[t]) : () => e;
    for (let e of i) n[e] = li(a(e));
    return n;
}
function di(e) {
    return ui(e, { top: `y`, right: `x`, bottom: `y`, left: `x` });
}
function fi(e) {
    return ui(e, [`topLeft`, `topRight`, `bottomLeft`, `bottomRight`]);
}
function X(e) {
    let t = di(e);
...
function Z(e, t) {
    ...
    let i = {
        ...
        lineHeight: ci(H(e.lineHeight, t.lineHeight), n),
        size: n,
        style: r,
        weight: H(e.weight, t.weight),
        string: ``,
    };
    return ((i.string = Ur(i)), i);
}
function pi(e, t, n, r) {
    let i = !0,
        a,
        ...
        if (
            ...
            s !== void 0 &&
                (t !== void 0 &&
                    typeof s == `function` &&
                    ((s = s(t)), (i = !1)),
                n !== void 0 && R(s) && ((s = s[n % s.length]), (i = !1)),
                s !== void 0))
        )
...
function gi(e, t = [``], n, r, i = () => e[0]) {
    let a = n || e;
    return (
        r === void 0 && (r = Mi(`_fallback`, e)),
        new Proxy(
            {
...
function _i(e, t, n, r) {
    let i = {
        ...
        _stack: new Set(),
        _descriptors: vi(e, r),
        setContext: (t) => _i(e, t, n, r),
        override: (i) => _i(e.override(i), t, n, r),
    };
    return new Proxy(i, {
        deleteProperty(t, n) {
...
function vi(e, t = { scriptable: !0, indexable: !0 }) {
    let {
    ...
    return {
        ...
        isIndexable: Mn(r) ? r : () => r,
    };
}
var yi = (e, t) => (e ? e + An(t) : t),
    bi = (e, t) =>
        z(t) &&
        e !== `adapters` &&
...
function Si(e, t, n) {
    let { _proxy: r, _context: i, _subProxy: a, _descriptors: o } = e,
        s = r[t];
    return (
        Mn(s) && o.isScriptable(t) && (s = Ci(t, s, e, n)),
        R(s) && s.length && (s = wi(t, s, e, o.isIndexable)),
        bi(t, s) && (s = _i(s, i, a && a[t], o)),
        s
    );
}
function Ci(e, t, n, r) {
    ...
    s.add(e);
    let c = t(a, o || r);
    return (s.delete(e), bi(e, c) && (c = Oi(i._scopes, i, e, c)), c);
}
function wi(e, t, n, r) {
...
var Ei = (e, t) => (e === !0 ? t : typeof e == `string` ? kn(t, e) : void 0);
function Di(e, t, n, r, i) {
    for (let a of t) {
        let t = Ei(n, a);
        if (t) {
            e.add(t);
            let a = Ti(t._fallback, n, i);
...
function Oi(e, t, n, r) {
    let i = t._rootScopes,
        a = Ti(t._fallback, n, r),
        o = [...e, ...i],
        s = new Set();
    s.add(r);
    let c = ki(s, o, n, a || n, r);
    return c === null ||
        (a !== void 0 && a !== n && ((c = ki(s, o, a, c, r)), c === null))
        ? !1
        : gi(Array.from(s), [``], i, a, () => Ai(t, n, r));
}
function ki(e, t, n, r, i) {
    for (; n;) n = Di(e, t, n, r, i);
    return n;
}
function Ai(e, t, n) {
    let r = e._getTarget();
...
function ji(e, t, n, r) {
    let i;
    for (let a of t)
        if (((i = Mi(yi(a, e), n)), i !== void 0))
            return bi(e, i) ? Oi(n, r, e, i) : i;
}
function Mi(e, t) {
    for (let n of t) {
        if (!n) continue;
...
function Ni(e) {
    let t = e._keys;
    return ((t ||= e._keys = Pi(e._scopes)), t);
}
function Pi(e) {
    let t = new Set();
    for (let n of e)
        for (let e of Object.keys(n).filter((e) => !e.startsWith(`_`)))
            t.add(e);
    return Array.from(t);
}
var Fi = 2 ** -52 || 1e-14,
    Ii = (e, t) => t < e.length && !e[t].skip && e[t],
    Li = (e) => (e === `x` ? `y` : `x`);
function Ri(e, t, n, r) {
    let i = e.skip ? t : e,
        a = t,
...
function Bi(e, t, n = `x`) {
    let r = Li(n),
        ...
        c = Ii(e, 0);
    for (let l = 0; l < i; ++l) {
        if (((o = s), (s = c), (c = Ii(e, l + 1)), !s)) continue;
        let i = s[n],
            u = s[r];
        (o &&
            ((a = (i - o[n]) / 3),
    ...
    for (n = 0, r = e.length; n < r; ++n)
        ((o = a),
            ...
            a &&
                ((i = e[n]),
                o &&
                    ((i.cp1x = Hi(i.cp1x, t.left, t.right)),
                    (i.cp1y = Hi(i.cp1y, t.top, t.bottom))),
                s &&
                    ((i.cp2x = Hi(i.cp2x, t.left, t.right)),
                    (i.cp2y = Hi(i.cp2y, t.top, t.bottom)))));
}
function Wi(e, t, n, r, i) {
    ...
    if (
        ...
        for (a = 0, o = e.length; a < o; ++a)
            ((s = e[a]),
                (c = Ri(n, s, e[Math.min(a + 1, o - +!r) % o], t.tension)),
                (s.cp1x = c.previous.x),
                (s.cp1y = c.previous.y),
                (s.cp2x = c.next.x),
                (s.cp2y = c.next.y),
...
var Ji = (e) => e.ownerDocument.defaultView.getComputedStyle(e, null);
function Yi(e, t) {
...
var Qi = (e, t, n) => (e > 0 || t > 0) && (!n || !n.shadowRoot);
function $i(e, t) {
    let n = e.touches,
        r = n && n.length ? n[0] : e,
    ...
    if (t === void 0 || n === void 0) {
        ...
        if (!a) ((t = e.clientWidth), (n = e.clientHeight));
            ...
            ((t = e.width - c.width - s.width),
                ...
                (r = qi(o.maxWidth, a, `clientWidth`)),
                (i = qi(o.maxHeight, a, `clientHeight`)));
        }
    }
    return { width: t, height: n, maxWidth: r || In, maxHeight: i || In };
}
var na = (e) => Math.round(e * 10) / 10;
function ra(e, t, n, r) {
    let i = Ji(e),
        a = Zi(i, `margin`),
        o = qi(i.maxWidth, e, `clientWidth`) || In,
        s = qi(i.maxHeight, e, `clientHeight`) || In,
        c = ta(e, t, n),
        { width: l, height: u } = c;
    if (i.boxSizing === `content-box`) {
        let e = Zi(i, `border`, `width`),
            t = Zi(i, `padding`);
    ...
    return (
        ...
        (l = na(Math.min(l, o, c.maxWidth))),
        (u = na(Math.min(u, s, c.maxHeight))),
        l && !u && (u = na(l / 2)),
        (t !== void 0 || n !== void 0) &&
            r &&
            c.height &&
            u > c.height &&
            ((u = c.height), (l = na(Math.floor(u * r)))),
        { width: l, height: u }
    );
}
function ia(e, t, n) {
    let r = t || 1,
        i = na(e.height * r),
        a = na(e.width * r);
    ((e.height = na(e.height)), (e.width = na(e.width)));
    let o = e.canvas;
    return (
        o.style &&
...
function ha(e) {
    return e === `angle`
        ? { between: nr, compare: er, normalize: tr }
        : { between: ar, compare: (e, t) => e - t, normalize: (e) => e };
}
function ga({ start: e, end: t, count: n, loop: r, style: i }) {
    return {
        start: e % n,
        end: t % n,
        loop: r && (t - e + 1) % n === 0,
...
function va(e, t, n) {
    ...
    let { property: r, start: i, end: a } = n,
        o = t.length,
        { compare: s, between: c, normalize: l } = ha(r),
        { start: u, end: d, loop: f, style: p } = _a(e, t, n),
        m = [],
        h = !1,
        g = null,
        _,
    ...
    return (
        g !== null &&
            m.push(ga({ start: g, end: d, loop: f, count: o, style: p })),
        m
    );
}
function ya(e, t) {
...
function Sa(e, t) {
    ...
    if (!i) return [];
    let a = !!e._loop,
        { start: o, end: s } = ba(n, i, a, r);
    return r === !0
        ? Ca(e, [{ start: o, end: s, loop: a }], n, t)
        : Ca(
              e,
              xa(
                  n,
...
function Ca(e, t, n, r) {
    return !r || !r.setContext || !n ? t : wa(e, t, n, r);
}
function wa(e, t, n, r) {
...
function Ea(e, t) {
    ...
    let n = [],
        r = function (e, t) {
            return Tr(t) ? (n.includes(t) || n.push(t), n.indexOf(t)) : t;
        };
...
function ka(e, t) {
    ...
    let r = Oa(t, e.chartArea);
    return {
        left: n.left === !1 ? 0 : r.left - (n.left === !0 ? 0 : n.left),
        right:
            n.right === !1 ? e.width : r.right + (n.right === !0 ? 0 : n.right),
        top: n.top === !1 ? 0 : r.top - (n.top === !0 ? 0 : n.top),
        bottom:
            n.bottom === !1
                ? e.height
                : r.bottom + (n.bottom === !0 ? 0 : n.bottom),
    };
}
var Aa = new (class {
        constructor() {
    ...
    Na = class {
        constructor(e, t, n, r) {
            let i = t[n];
            r = pi([e.to, r, i, e.from]);
            let a = pi([e.from, i, r]);
            ((this._active = !0),
                (this._fn = e.fn || Ma[e.type || typeof a]),
                (this._easing = wr[e.easing] || wr.linear),
        ...
        update(e, t, n) {
            if (this._active) {
                ...
                ((this._start = n),
                    ...
                    (this._total += i),
                    (this._loop = !!e.loop),
                    (this._to = pi([e.to, t, r, e.from])),
                    (this._from = pi([e.from, r, t])));
            }
        }
        cancel() {
            this._active &&
    ...
    Pa = class {
        ...
        _animateOptions(e, t) {
            ...
            return (
                n.$shared &&
                    Fa(e.options.$animations, n).then(
                        () => {
                            e.options = n;
                        },
                        () => {},
        ...
        update(e, t) {
            ...
            if (n.length) return (Aa.add(this._chart, n), !0);
        }
    };
function Fa(e, t) {
    let n = [],
...
function Ja(e, t) {
    ...
    for (let e = 0; e < d; ++e) {
        ...
        ((f = p[l] = Ka(i, u, a)),
            (f[s] = d),
            (f._top = qa(f, o, !0, r.type)),
            (f._bottom = qa(f, o, !1, r.type)));
...
var $a = (e) => e === `reset` || e === `none`,
    eo = (e, t) => (t ? e : Object.assign({}, e)),
    to = (e, t, n) =>
        e && !t.hidden && t._stacked && { keys: Ba(n, !0), values: null },
    no = class {
        static defaults = {};
        ...
        updateIndex(e) {
            (this.index !== e && Qa(this._cachedMeta), (this.index = e));
        }
        linkScales() {
            let e = this.chart,
                t = this._cachedMeta,
                ...
                i = (t.xAxisID = H(n.xAxisID, Ya(e, `x`))),
                a = (t.yAxisID = H(n.yAxisID, Ya(e, `y`))),
                o = (t.rAxisID = H(n.rAxisID, Ya(e, `r`))),
                s = t.indexAxis,
        ...
        _destroy() {
            let e = this._cachedMeta;
            (this._data && fr(this._data, this), e._stacked && Qa(e));
        }
        _dataCheck() {
            ...
            if (z(t)) {
                ...
                (t && Object.isExtensible(t) && dr(t, this),
                    (this._syncList = []),
                    (this._data = t));
            }
        }
        ...
        buildOrUpdateElements(e) {
            ...
            this._dataCheck();
            let i = t._stacked;
            ((t._stacked = Ua(t.vScale, t)),
                t.stack !== n.stack && ((r = !0), Qa(t), (t.stack = n.stack)),
                this._resyncElements(e),
                (r || i !== t._stacked) &&
                    (Ja(this, t._parsed), (t._stacked = Ua(t.vScale, t))));
        }
        configure() {
        ...
        applyStack(e, t, n) {
            let r = this.chart,
                ...
                a = t[e.axis];
            return Va(
                { keys: Ba(r, !0), values: t._stacks[e.axis]._visualValues },
                a,
                i.index,
                { mode: n },
            );
        ...
        updateRangeFromParsed(e, t, n, r) {
            ...
            (r && o && ((r.values = o), (a = Va(r, i, this._cachedMeta.index))),
        ...
        _update(e) {
            ...
            (this.update(e || `default`),
                (t._clip = za(
                    H(
                        this.options.clip,
                        Ra(t.xScale, t.yScale, this.getMaxOverflow()),
                    ),
                )));
        }
        update(e) {}
        draw() {
            let e = this._ctx,
                ...
                l;
            for (
                n.dataset && n.dataset.draw(e, i, o, s), l = o;
                l < o + s;
                ++l
            ) {
                let t = r[l];
        ...
        getContext(e, t, n) {
            ...
            if (e >= 0 && e < this._cachedMeta.data.length) {
                ...
                ((i = t.$context ||= Za(this.getContext(), e, t)),
                    (i.parsed = this.getParsed(e)),
                    (i.raw = r.data[e]),
                    (i.index = i.dataIndex = e));
            } else
                ((i = this.$context ||=
                    Xa(this.chart.getContext(), this.index)),
                    (i.dataset = r),
        ...
        _resolveElementOptions(e, t = `default`, n) {
            let r = t === `active`,
                ...
                a = e + `-` + t,
                o = i[a],
                s = this.enableOptionSharing && jn(n);
            if (o) return eo(o, s);
            let c = this.chart.config,
                ...
                p = c.resolveNamedOptions(
                    d,
                    f,
                    () => this.getContext(n, r, t),
                    u,
                );
            return (
                p.$shared &&
                    ((p.$shared = s), (i[a] = Object.freeze(eo(p, s)))),
                p
            );
        }
        ...
        includeOptions(e, t) {
            return !t || $a(e) || this.chart._animationsDisabled;
        }
        ...
        updateSharedOptions(e, t, n) {
            e && !$a(t) && this._resolveAnimations(void 0, t).update(e, n);
        }
        _setStyle(e, t, n, r) {
            e.active = r;
        ...
        _insertElements(e, t, n = !0) {
            let r = this._cachedMeta,
                ...
                o,
                s = (e) => {
                    for (e.length += t, o = e.length - 1; o >= a; o--)
                        e[o] = e[o - t];
                };
...
function ro(e, t) {
    if (!e._cache.$bar) {
        ...
        e._cache.$bar = pr(r.sort((e, t) => e - t));
    }
    return e._cache.$bar;
}
function io(e) {
    let t = e.iScale,
        ...
        c = () => {
            o === 32767 ||
                o === -32768 ||
                (jn(s) && (r = Math.min(r, Math.abs(o - s) || r)), (s = o));
        };
...
function co(e, t, n, r) {
    return (R(e) ? so(e, t, n, r) : (t[n.axis] = n.parse(e, r)), t);
}
function lo(e, t, n, r) {
    let i = e.iScale,
        a = e.vScale,
...
function mo(e, t, n, r) {
    ...
    let { start: o, end: s, reverse: c, top: l, bottom: u } = po(e);
    (i === `middle` &&
        n &&
...
function ho(e, t, n, r) {
    return (r ? ((e = go(e, t, n)), (e = _o(e, n, t))) : (e = _o(e, t, n)), e);
}
function go(e, t, n) {
...
function vo(e, { inflateAmount: t }, n) {
...
var yo = class extends no {
        ...
        parseObjectData(e, t, n, r) {
            ...
            for (d = n, f = n + r; d < f; ++d)
                ((m = t[d]),
                    (p = {}),
                    (p[i.axis] = i.parse(kn(m, c), d)),
                    u.push(co(kn(m, l), p, a, d)));
            return u;
        }
        updateRangeFromParsed(e, t, n, r) {
        ...
        updateElements(e, t, n, r) {
            let i = r === `reset`,
                ...
                c = o.isHorizontal(),
                l = this._getRuler(),
                { sharedOptions: u, includeOptions: d } =
        ...
        _calculateBarValuePixels(e) {
            ...
            (f !== u && ((d = f - u), (f = u)),
                l &&
                    ...
                    u !== 0 && Vn(u) !== Vn(c.barEnd) && (d = 0),
                    (d += u)));
            let h = !L(i) && !l ? i : d,
                g = t.getPixelForValue(h);
            if (
                ((p = this.chart.getDataVisibility(e)
                    ? t.getPixelForValue(d + f)
                    : g),
                (m = p - g),
                Math.abs(m) < a)
            ) {
                ((m = fo(m, t, o) * a), u === o && (g -= m / 2));
            ...
            if (g === t.getPixelForValue(o)) {
                let e = (Vn(m) * t.getLineWidthForValue(o)) / 2;
                ((g += e), (m -= e));
            }
            ...
            if (t.grouped) {
                let n = i ? this._getStackCount(e) : t.stackCount,
                    ...
                    d = this._getAxis().indexOf(
                        H(u, this.getFirstScaleIdForIndexAxis()),
                    ),
                    f =
                        this._getStackIndex(
                            this.index,
    ...
    bo = class extends no {
        ...
        updateElements(e, t, n, r) {
            let i = r === `reset`,
                ...
                { sharedOptions: l, includeOptions: u } =
                    this._getSharedOptions(t, r),
                d = a.axis,
                f = o.axis,
...
function Do(e, t, n, r) {
    ...
    function a(e, n, a) {
        let { startAngle: o, endAngle: s } = e.getProps(
            ...
            { angle: c } = Qn(e, { x: t.x, y: t.y });
        nr(c, o, s) && i.push({ element: e, datasetIndex: n, index: a });
    }
    return (wo(e, n, t, a), i);
}
...
var jo = {
        evaluateInteractionItems: wo,
        modes: {
            index(e, t, n, r) {
                let i = ea(t, e),
                    a = n.axis || `x`,
                    o = n.includeInvisible || !1,
                    s = n.intersect ? Eo(e, i, a, r, o) : ko(e, i, a, !1, r, o),
                    c = [];
                return s.length
            ...
            nearest(e, t, n, r) {
                let i = ea(t, e),
                    a = n.axis || `xy`,
                    o = n.includeInvisible || !1;
                return ko(e, i, a, n.intersect, r, o);
            },
            x(e, t, n, r) {
                return Ao(e, ea(t, e), `x`, n.intersect, r);
            },
            y(e, t, n, r) {
                return Ao(e, ea(t, e), `y`, n.intersect, r);
            },
        },
    },
    Mo = [`left`, `top`, `right`, `bottom`];
function No(e, t) {
    return e.filter((e) => e.pos === t);
}
function Po(e, t) {
    return e.filter((e) => Mo.indexOf(e.pos) === -1 && e.box.axis === t);
}
function Fo(e, t) {
    return e.sort((e, n) => {
        let r = t ? n : e,
...
function Ho(e, t, n, r) {
    ...
    a.getPadding && Vo(o, a.getPadding());
    let s = Math.max(0, t.outerWidth - Bo(o, e, `left`, `right`)),
        c = Math.max(0, t.outerHeight - Bo(o, e, `top`, `bottom`)),
        l = s !== e.w,
        u = c !== e.h;
    return (
        (e.w = s),
...
function Go(e, t, n, r) {
    ...
    for (a = 0, o = e.length, l = 0; a < o; ++a) {
        ((s = e[a]),
            (c = s.box),
            c.update(s.width || t.w, s.height || t.h, Wo(s.horizontal, t)));
        let { same: o, other: d } = Ho(t, n, s, r);
        ((l |= o && i.length), (u ||= d), c.fullSize || i.push(s));
    }
    return (l && Go(i, t, n, r)) || u;
}
...
function qo(e, t, n, r) {
    ...
    for (let s of e) {
        ...
        if (s.horizontal) {
            let r = t.w * l,
                a = c.size || e.height;
            (jn(c.start) && (o = c.start),
                e.fullSize
                    ? Ko(e, i.left, o, n.outerWidth - i.right - i.left, a)
                    : Ko(e, t.left + c.placed, o, r, a),
                (c.start = o),
                (c.placed += r),
                (o = e.bottom));
        } else {
            let r = t.h * l,
                o = c.size || e.width;
            (jn(c.start) && (a = c.start),
                e.fullSize
                    ? Ko(e, a, i.top, o, n.outerHeight - i.bottom - i.top)
                    : Ko(e, a, t.top + c.placed, o, r),
                (c.start = a),
                (c.placed += r),
                (a = e.right));
        }
...
var Jo = {
        ...
        update(e, t, n, r) {
            ...
            let u =
                    c.reduce(
                        (e, t) =>
                            t.box.options && t.box.options.display === !1
                                ? e
                                : e + 1,
                        0,
                    ) || 1,
            ...
            (Go(s.fullSize, p, d, m),
                Go(c, p, d, m),
                Go(l, p, d, m) && Go(c, p, d, m),
                Uo(p),
                qo(s.leftAndTop, p, d, m),
                (p.x += p.w),
                (p.y += p.h),
                qo(s.rightAndBottom, p, d, m),
                (e.chartArea = {
                    left: p.left,
                    top: p.top,
                    right: p.left + p.w,
...
var ts = aa ? { passive: !0 } : !1;
function ns(e, t, n) {
    e && e.addEventListener(t, n, ts);
}
function rs(e, t, n) {
    e && e.canvas && e.canvas.removeEventListener(t, n, ts);
}
function is(e, t) {
    let n = Qo[e.type] || e.type,
        { x: r, y: i } = ea(e, t);
    return {
        type: n,
        chart: t,
...
function os(e, t, n) {
    let r = e.canvas,
        i = new MutationObserver((e) => {
            let t = !1;
            for (let n of e)
                ((t ||= as(n.addedNodes, r)), (t &&= !as(n.removedNodes, r)));
            t && n();
        });
...
function ss(e, t, n) {
    let r = e.canvas,
        i = new MutationObserver((e) => {
            let t = !1;
            for (let n of e)
                ((t ||= as(n.removedNodes, r)), (t &&= !as(n.addedNodes, r)));
            t && n();
        });
    return (i.observe(document, { childList: !0, subtree: !0 }), i);
}
...
function ds(e, t) {
    (cs.size || window.addEventListener(`resize`, us), cs.set(e, t));
}
function fs(e) {
    (cs.delete(e), cs.size || window.removeEventListener(`resize`, us));
}
function ps(e, t, n) {
    let r = e.canvas,
        i = r && Ki(r);
    ...
    return (o.observe(i), ds(e, a), o);
}
function ms(e, t, n) {
    (n && n.disconnect(), t === `resize` && fs(e));
}
function hs(e, t, n) {
    let r = e.canvas,
        i = hr((t) => {
...
var gs = class extends Yo {
    acquireContext(e, t) {
        ...
        return n && n.canvas === e ? (es(e, t), n) : null;
    }
    releaseContext(e) {
        let t = e.canvas;
        if (!t[Zo]) return !1;
    ...
    addEventListener(e, t, n) {
        ...
        let r = (e.$proxies ||= {});
        r[t] = ({ attach: os, detach: ss, resize: ps }[t] || hs)(e, t, n);
    }
    removeEventListener(e, t) {
        let n = (e.$proxies ||= {}),
            r = n[t];
        r &&
            (({ attach: ms, detach: ms, resize: ms }[t] || rs)(e, t, r),
            (n[t] = void 0));
    }
    getDevicePixelRatio() {
...
function ys(e, t) {
    let n = e.options.ticks,
        ...
        a = n.major.enabled ? Ss(t) : [],
        o = a.length,
        s = a[0],
        c = a[o - 1],
        l = [];
    if (o > i) return (Cs(t, l, a, o / i), l);
    let u = xs(a, t, i);
    if (o > 0) {
        let e,
            n,
            r = o > 1 ? Math.round((c - s) / (o - 1)) : null;
        for (ws(t, l, u, L(r) ? 0 : s - r, s), e = 0, n = o - 1; e < n; e++)
            ws(t, l, u, a[e], a[e + 1]);
        return (ws(t, l, u, c, L(r) ? t.length : c + r), l);
    }
    return (ws(t, l, u), l);
}
function bs(e) {
...
var Es = (e) => (e === `left` ? `right` : e === `right` ? `left` : e),
    Ds = (e, t, n) => (t === `top` || t === `left` ? e[t] + n : e[t] - n),
    Os = (e, t) => Math.min(t || e, e);
function ks(e, t) {
    let n = [],
        r = e.length / t,
        i = e.length,
...
function Ps(e, t) {
    return hi(e, { scale: t, type: `scale` });
}
function Fs(e, t, n) {
    return hi(e, { tick: n, index: t, type: `tick` });
}
function Is(e, t, n) {
    let r = _r(e);
    return (((n && t !== `right`) || (!n && t === `right`)) && (r = Es(r)), r);
}
function Ls(e, t, n, r) {
    ...
    if (e.isHorizontal()) {
        if (((p = J(r, a, s)), z(n))) {
            ...
            m = n === `center` ? (l.bottom + l.top) / 2 + h - t : Ds(e, n, t);
        f = s - a;
    } else {
        if (z(n)) {
            let e = Object.keys(n)[0],
            ...
            p = n === `center` ? (l.left + l.right) / 2 - g + t : Ds(e, n, t);
        ((m = J(r, o, i)), (d = n === `left` ? -q : q));
    }
    return { titleX: p, titleY: m, maxWidth: f, rotation: d };
}
var Rs = class e extends vs {
        constructor(e) {
            (super(),
                (this.id = e.id),
                (this.type = e.type),
        ...
        update(e, t, n) {
            ...
            (this.beforeUpdate(),
                ...
                (this._dataLimitsCached ||=
                    ...
                    (this._range = mi(this, i, r)),
                    !0)),
                this.beforeBuildTicks(),
                (this.ticks = this.buildTicks() || []),
                this.afterBuildTicks());
            let s = o < this.ticks.length;
            (this._convertTicksToLabels(s ? ks(this.ticks, o) : this.ticks),
                this.configure(),
        ...
        generateTickLabels(e) {
            let t = this.options.ticks,
                ...
                i;
            for (n = 0, r = e.length; n < r; n++)
                ((i = e[n]), (i.label = U(t.callback, [i.value, n, e], this)));
        }
        ...
        calculateLabelRotation() {
            let e = this.options,
                t = e.ticks,
                n = Os(this.ticks.length, e.ticks.maxTicksLimit),
                r = t.minRotation || 0,
                i = t.maxRotation,
                a = r,
                o,
            ...
            let l = this._getLabelSizes(),
                u = l.widest.width,
                d = l.highest.height,
                f = rr(this.chart.width - u, 0, this.maxWidth);
            ((o = e.offset ? this.maxWidth / n : f / (n - 1)),
                u + 6 > o &&
                    ...
                    (s =
                        ...
                        Ms(e.grid) -
                        t.padding -
                        Ns(e.title, this.chart.options.font)),
                    (c = Math.sqrt(u * u + d * d)),
                    (a = Xn(
                        Math.min(
                            Math.asin(rr((l.highest.height + 6) / o, -1, 1)),
                            Math.asin(rr(s / c, -1, 1)) -
                                Math.asin(rr(d / c, -1, 1)),
                        ),
                    )),
        ...
        fit() {
            let e = { width: 0, height: 0 },
                ...
                o = this.isHorizontal();
            if (a) {
                let a = Ns(r, t.options.font);
                if (
                    (o
                        ? ((e.width = this.maxWidth), (e.height = Ms(i) + a))
                        : ((e.height = this.maxHeight), (e.width = Ms(i) + a)),
        ...
        _computeLabelSizes(e, t, n) {
            ...
            for (u = 0; u < t; u += s) {
                if (
                    ...
                    ((v = Wr(r, g.data, g.gc, v, p)), (y = _));
                else if (R(p))
                    for (d = 0, f = p.length; d < f; ++d)
                        ((b = p[d]),
                            !L(b) &&
                                !R(b) &&
                                ((v = Wr(r, g.data, g.gc, v, b)), (y += _)));
                (a.push(v),
                    o.push(y),
                    (c = Math.max(v, c)),
                    (l = Math.max(y, l)));
        ...
        getPixelForDecimal(e) {
            ...
            return ir(this._alignToPixels ? Kr(this.chart, t, 0) : t);
        }
        ...
        getContext(e) {
            ...
            if (e >= 0 && e < t.length) {
                let n = t[e];
                return (n.$context ||= Fs(this.getContext(), e, n));
            }
            return (this.$context ||= Ps(this.chart.getContext(), this));
        }
        _tickSize() {
            let e = this.options.ticks,
                t = Yn(this.labelRotation),
        ...
        _computeGridLineItems(e) {
            ...
            if (a === `top`)
                ...
                ((T = e.top), (ee = e.bottom), (x = g + m), (C = x + u));
            } else if (t === `y`) {
            ...
            let D = H(r.ticks.maxTicksLimit, l),
                O = Math.max(1, Math.ceil(l / D));
            for (_ = 0; _ < l; _ += O) {
                      ...
                      (ee =
                          r === `top`
                              ? c === `near` || m !== 0
                                  ? -E * T + T / 2
                                  : c === `center`
                                    ? -O.highest.height / 2 - t * T + T
                                    : -O.highest.height + T / 2
                              : c === `near` || m !== 0
                                ? T / 2
                                : c === `center`
                                  ? O.highest.height / 2 - t * T
                                  : O.highest.height - E * T),
                      u && (ee *= -1),
                      m !== 0 &&
                          !e.showLabelBackdrop &&
                          (b += (T / 2) * Math.sin(m)))
        ...
        _getXAxisLabelAlignment() {
            ...
            if (-Yn(this.labelRotation)) return e === `top` ? `left` : `right`;
            let n = `center`;
            return (
                t.align === `start`
                    ? (n = `left`)
        ...
        drawBorder() {
            ...
            let o = r.setContext(this.getContext(0)).lineWidth,
                ...
                d;
            (this.isHorizontal()
                ? ((c = Kr(e, this.left, a) - a / 2),
                  (l = Kr(e, this.right, o) + o / 2),
                  (u = d = s))
                : ((u = Kr(e, this.top, a) - a / 2),
                  (d = Kr(e, this.bottom, o) + o / 2),
                  (c = l = s)),
                t.save(),
                (t.lineWidth = i.width),
        ...
        drawTitle() {
            ...
            let i = Z(n.font),
                ...
                o = n.align,
                s = i.lineHeight / 2;
            t === `bottom` || t === `center` || z(t)
                ? ((s += a.bottom),
                  R(n.text) && (s += i.lineHeight * (n.text.length - 1)))
                : (s += a.top);
            let {
                titleX: c,
                titleY: l,
    ...
    zs = class {
        ...
        unregister(e) {
            ...
            (n in t && delete t[n],
                r &&
                    n in Y[r] &&
                    (delete Y[r][n], this.override && delete zr[n]));
        }
    };
function Bs(e, t, n) {
    let r = Cn(Object.create(null), [n ? Y.get(n) : {}, Y.get(t), e.defaults]);
    (Y.set(t, r),
        e.defaultRoutes && Vs(t, e.defaultRoutes),
...
var Us = new (class {
        ...
        _exec(e, t, n) {
            let r = An(e);
            (U(n[`before` + r], [], n), t[e](n), U(n[`after` + r], [], n));
        }
    ...
    Ws = class {
        ...
        _notify(e, t, n, r) {
            ...
            for (let i of e) {
                let e = i.plugin,
                    a = e[n];
                if (U(a, [t, r, i.options], e) === !1 && r.cancelable)
                    return !1;
            }
            return !0;
        }
        ...
        _createDescriptors(e, t) {
            let n = e && e.config,
                r = H(n.options && n.options.plugins, {}),
                i = Gs(n);
            return r === !1 && !t ? [] : qs(e, i, r, t);
        }
        _notifyStateChanges(e) {
            let t = this._oldCache || [],
                ...
                r = (e, t) =>
                    e.filter(
                        (e) => !t.some((t) => e.plugin.id === t.plugin.id),
                    );
...
function Gs(e) {
    let t = {},
        n = [],
        r = Object.keys(Us.plugins.items);
...
function qs(e, { plugins: t, localIds: n }, r, i) {
    let a = [],
        o = e.getContext();
    for (let s of t) {
        let t = s.id,
        ...
        c !== null &&
            a.push({
                plugin: s,
                options: Js(e.config, { plugin: s, local: n[t] }, c, o),
            });
    }
    return a;
}
function Js(e, { plugin: t, local: n }, r, i) {
...
function nc(e, t) {
    if (t.data && t.data.datasets) {
        let n = t.data.datasets.filter(
            (t) => t.xAxisID === e || t.yAxisID === e,
        );
        if (n.length) return tc(e, `x`, n[0]) || tc(e, `y`, n[0]);
    }
    return {};
}
function rc(e, t) {
    let n = zr[e.type] || { scales: {} },
        r = t.scales || {},
        i = Ys(e.type, t),
    ...
    return (
        Object.keys(r).forEach((t) => {
            ...
            let s = ec(t, o, nc(t, e), Y.scales[o.type]),
                c = Zs(s, i),
                l = n.scales || {};
            a[t] = wn(Object.create(null), [{ axis: s }, o, l[s], l[c]]);
        }),
        e.data.datasets.forEach((n) => {
            let i = n.type || e.type,
                o = n.indexAxis || Ys(i, t),
                s = (zr[i] || {}).scales || {};
            Object.keys(s).forEach((e) => {
                let t = Xs(e, o),
                    i = n[t + `AxisID`] || t;
                ((a[i] = a[i] || Object.create(null)),
                    wn(a[i], [{ axis: t }, r[i], s[e]]));
            });
        }),
        Object.keys(a).forEach((e) => {
            let t = a[e];
            wn(t, [Y.scales[t.type], Y.scale]);
        }),
        a
    );
}
function ic(e) {
    let t = (e.options ||= {});
    ((t.plugins = H(t.plugins, {})), (t.scales = rc(e, t)));
}
function ac(e) {
    return (
        (e ||= {}),
...
function oc(e) {
    return ((e ||= {}), (e.data = ac(e.data)), ic(e), e);
}
var sc = new Map(),
    cc = new Set();
function lc(e, t) {
    let n = sc.get(e);
    return (n || ((n = t()), sc.set(e, n), cc.add(n)), n);
}
var uc = (e, t, n) => {
        let r = kn(t, n);
        r !== void 0 && e.add(r);
    ...
    dc = class {
        ...
        update() {
            let e = this._config;
            (this.clearCache(), ic(e));
        }
        clearCache() {
            (this._scopeCache.clear(), this._resolverCache.clear());
        }
        datasetScopeKeys(e) {
            return lc(e, () => [[`datasets.${e}`, ``]]);
        }
        datasetAnimationScopeKeys(e, t) {
            return lc(`${e}.transition.${t}`, () => [
        ...
        getOptionScopes(e, t, n) {
            ...
            let s = new Set();
            t.forEach((t) => {
                (e && (s.add(e), t.forEach((t) => uc(s, e, t))),
                    t.forEach((e) => uc(s, r, e)),
                    t.forEach((e) => uc(s, zr[i] || {}, e)),
                    t.forEach((e) => uc(s, Y, e)),
                    t.forEach((e) => uc(s, Br, e)));
            });
            let c = Array.from(s);
            return (
        ...
        chartOptionScopes() {
            ...
            return [e, zr[t] || {}, Y.datasets[t] || {}, { type: t }, Y, Br];
        }
        resolveNamedOptions(e, t, n, r = [``]) {
            let i = { $shared: !0 },
                { resolver: a, subPrefixes: o } = fc(this._resolverCache, e, r),
                s = a;
            if (mc(a, t)) {
                ((i.$shared = !1), (n = Mn(n) ? n() : n));
        ...
        createResolver(e, t, n = [``], r) {
            let { resolver: i } = fc(this._resolverCache, e, n);
            return z(t) ? _i(i, t, void 0, r) : i;
        }
    };
function fc(e, t, n) {
    let r = e.get(t);
        ...
        a ||
            ((a = {
                ...
                subPrefixes: n.filter(
                    (e) => !e.toLowerCase().includes(`hover`),
                ),
            }),
            r.set(i, a)),
        a
...
var pc = (e) => z(e) && Object.getOwnPropertyNames(e).some((t) => Mn(e[t]));
function mc(e, t) {
    let { isScriptable: n, isIndexable: r } = vi(e);
    for (let i of t) {
        let t = n(i),
            a = r(i),
            o = (a || t) && e[i];
        if ((t && (Mn(o) || pc(o))) || (a && R(o))) return !0;
    }
    return !1;
}
var hc = `4.5.1`,
    gc = [`top`, `bottom`, `left`, `right`, `chartArea`];
function _c(e, t) {
    return e === `top` || e === `bottom` || (gc.indexOf(e) === -1 && t === `x`);
}
function vc(e, t) {
    return function (n, r) {
...
var Ec = class {
    ...
    constructor(e, t) {
        ...
        ((this.platform = new (n.platform || _s(r))()),
        ...
        if (
            ...
            (this.scales = {}),
            (this._plugins = new Ws()),
            (this.$proxies = {}),
            (this._hiddenIndices = {}),
            (this.attached = !1),
            (this._animationsDisabled = void 0),
            (this.$context = void 0),
            (this._doResize = gr((e) => this.update(e), a.resizeDelay || 0)),
            (this._dataChanges = []),
            (Sc[this.id] = this),
            !o || !s)
        ) {
        ...
        (Aa.listen(this, `complete`, yc),
            Aa.listen(this, `progress`, bc),
            this._initialize(),
    ...
    _initialize() {
        return (
            ...
            this.options.responsive
                ? this.resize()
                : ia(this, this.options.devicePixelRatio),
            this.bindEvents(),
    ...
    clear() {
        return (qr(this.canvas, this.ctx), this);
    }
    stop() {
    ...
    _resize(e, t) {
        ...
        ((this.width = a.width),
            ...
            ia(this, o, !0) &&
                ...
                U(n.onResize, [this, a], this),
                this.attached && this._doResize(s) && this.render()));
    }
    ensureScalesHaveIDs() {
        W(this.options.scales || {}, (e, t) => {
            e.id = t;
        });
    }
    buildOrUpdateScales() {
        ...
        (t &&
            ...
            W(i, (t) => {
                let i = t.options,
                    ...
                    s = H(i.type, t.dtype);
                ((i.position === void 0 ||
                    _c(i.position, o) !== _c(t.dposition)) &&
            ...
            W(n, (e) => {
                (Jo.configure(this, e, e.options), Jo.addBox(this, e));
            }));
    }
    _updateMetasets() {
        ...
        this._sortedMetasets = e.slice(0).sort(vc(`order`, `index`));
    }
    ...
    buildOrUpdateControllers() {
        let e = [],
            ...
            r;
        for (
            this._removeUnreferencedMetasets(), n = 0, r = t.length;
            n < r;
            n++
        ) {
            let r = t[n],
            ...
            if (
                ...
                (i.type = a),
                (i.indexAxis = r.indexAxis || Ys(a, this.options)),
                (i.order = r.order || 0),
                (i.index = n),
                (i.label = `` + r.label),
                ...
                let t = Us.getController(a),
                    { datasetElementType: r, dataElementType: o } =
                        Y.datasets[a];
                (Object.assign(t, {
    ...
    _checkEventBindings() {
        let e = this.options;
        (!Nn(new Set(Object.keys(this._listeners)), new Set(e.events)) ||
    ...
    _getUniformDataChanges() {
        ...
        let t = this.data.datasets.length,
            ...
            r = n(0);
        for (let e = 1; e < t; e++) if (!Nn(r, n(e))) return;
        return Array.from(r)
            .map((e) => e.split(`,`))
    ...
    _updateLayout(e) {
        if (this.notifyPlugins(`beforeLayout`, { cancelable: !0 }) === !1)
            return;
        Jo.update(this, this.width, this.height, e);
    ...
    _updateDatasets(e) {
        if (
            ...
            for (let t = 0, n = this.data.datasets.length; t < n; ++t)
                this._updateDataset(t, Mn(e) ? e({ datasetIndex: t }) : e);
    ...
    getContext() {
        return (this.$context ||= hi(null, { chart: this, type: `chart` }));
    }
    ...
    _stop() {
        let e, t;
        for (
            this.stop(), Aa.remove(this), e = 0, t = this.data.datasets.length;
            e < t;
            ++e
        )
    ...
    unbindEvents() {
        (W(this._listeners, (e, t) => {
            this.platform.removeEventListener(this, t, e);
        }),
            (this._listeners = {}),
            W(this._responsiveListeners, (e, t) => {
                this.platform.removeEventListener(this, t, e);
            }),
            (this._responsiveListeners = void 0));
    }
    ...
    _handleEvent(e, t, n) {
        let { _active: r = [], options: i } = this,
            ...
            s = Pn(e),
            c = Tc(e, this._lastEvent, n, s);
        n &&
            ((this._lastEvent = null),
            U(i.onHover, [e, o, this], this),
            s && U(i.onClick, [e, o, this], this));
        let l = !yn(o, r);
        return (
...
function Dc() {
    return W(Ec.instances, (e) => e._plugins.invalidate());
}
function Oc(e, t, n = t) {
    ((e.lineCap = H(n.borderCapStyle, t.borderCapStyle)),
        e.setLineDash(H(n.borderDash, t.borderDash)),
        (e.lineDashOffset = H(n.borderDashOffset, t.borderDashOffset)),
        (e.lineJoin = H(n.borderJoinStyle, t.borderJoinStyle)),
        (e.lineWidth = H(n.borderWidth, t.borderWidth)),
        (e.strokeStyle = H(n.borderColor, t.borderColor)));
}
function kc(e, t, n) {
    e.lineTo(n.x, n.y);
}
...
function Mc(e, t, n, r) {
    let { points: i, options: a } = t,
        { count: o, start: s, loop: c, ilen: l } = jc(i, n, r),
        u = Ac(a),
    ...
    for (p = 0; p <= l; ++p)
        ((m = i[(s + (f ? l - p : p)) % o]),
            !m.skip &&
                ...
                (h = m)));
    return (
        c && ((m = i[(s + (f ? l : 0)) % o]), u(e, h, m, f, a.stepped)),
        !!c
    );
}
function Nc(e, t, n, r) {
    let i = t.points,
        { count: a, start: o, ilen: s } = jc(i, n, r),
...
var Rc = typeof Path2D == `function`;
function zc(e, t, n, r) {
    Rc && !t.options.segment ? Ic(e, t, n, r) : Lc(e, t, n, r);
}
var Bc = class extends vs {
    static id = `line`;
    static defaults = {
        borderCapStyle: `butt`,
        borderDash: [],
    ...
    updateControlPoints(e, t) {
        ...
        if (
            ...
            (Wi(this._points, n, e, r, t), (this._pointsUpdated = !0));
        }
    }
    set points(e) {
        ((this._points = e),
    ...
    get segments() {
        return (this._segments ||= Sa(this, this.options.segment));
    }
    first() {
        let e = this.segments,
            t = this.points;
    ...
    interpolate(e, t) {
        let n = this.options,
            r = e[t],
            i = this.points,
            a = ya(this, { property: t, start: r, end: r });
        if (!a.length) return;
        let o = [],
            s = Fc(n),
            c,
    ...
    draw(e, t, n, r) {
        ...
        ((this.points || []).length &&
            i.borderWidth &&
            (e.save(), zc(e, this, n, r), e.restore()),
            this.animated &&
...
var Hc = class extends vs {
    ...
    inXRange(e, t) {
        return Vc(this, e, `x`, t);
    }
    inYRange(e, t) {
        return Vc(this, e, `y`, t);
    }
    getCenterPoint(e) {
        let { x: t, y: n } = this.getProps([`x`, `y`], e);
        return { x: t, y: n };
    ...
    draw(e, t) {
        ...
        this.skip ||
            n.radius < 0.1 ||
            !Xr(this, t, this.size(n) / 2) ||
            ((e.strokeStyle = n.borderColor),
            (e.lineWidth = n.borderWidth),
            (e.fillStyle = n.backgroundColor),
            Jr(e, n, this.x, this.y));
    }
    getRange() {
        let e = this.options || {};
...
function Gc(e, t, n) {
    let r = e.options.borderWidth,
        ...
        a = di(r);
    return {
        t: Wc(i.top, a.top, 0, n),
        r: Wc(i.right, a.right, 0, t),
        b: Wc(i.bottom, a.bottom, 0, n),
        l: Wc(i.left, a.left, 0, t),
    };
}
function Kc(e, t, n) {
    let { enableBorderRadius: r } = e.getProps([`enableBorderRadius`]),
        ...
        c = r || z(i);
    return {
        topLeft: Wc(!c || s.top || s.left, a.topLeft, 0, o),
        topRight: Wc(!c || s.top || s.right, a.topRight, 0, o),
        bottomLeft: Wc(!c || s.bottom || s.left, a.bottomLeft, 0, o),
        bottomRight: Wc(!c || s.bottom || s.right, a.bottomRight, 0, o),
    };
}
function qc(e) {
    let t = Uc(e),
...
function Jc(e, t, n, r) {
    let i = t === null,
        a = n === null,
        o = e && !(i && a) && Uc(e, r);
    return o && (i || ar(t, o.left, o.right)) && (a || ar(n, o.top, o.bottom));
}
function Yc(e) {
...
var Qc = class extends vs {
    ...
    inXRange(e, t) {
        return Jc(this, e, null, t);
    }
    inYRange(e, t) {
        return Jc(this, null, e, t);
    }
    getCenterPoint(e) {
        let {
            x: t,
...
function $c(e, t, n) {
    ...
    for (let e of r) {
        ...
        let l = ya(t, c);
        for (let t of l) {
            let r = el(n, a[t.start], a[t.end], t.loop),
                s = va(e, i, r);
            for (let e of s)
                o.push({
                    source: e,
                    target: t,
                    start: { [n]: rl(c, r, `start`, Math.max) },
                    end: { [n]: rl(c, r, `end`, Math.min) },
                });
        }
    }
    return o;
...
function tl(e, t) {
    ...
    return (
        t.segments.forEach(({ start: e, end: t }) => {
            ...
            r === null
                ? n !== null &&
                  (a.push({ x: n, y: o.y }), a.push({ x: n, y: s.y }))
...
function sl(e, t, n) {
    let r = dl(e);
    if (z(r)) return !isNaN(r.value) && r;
    let i = parseFloat(r);
    return B(i) && Math.floor(i) === i
        ? cl(r[0], t, i, n)
...
function fl(e) {
    let { scale: t, index: n, line: r } = e,
        ...
        o = r.points,
        s = pl(t, n);
    s.push(il({ x: null, y: t.bottom }, r));
    for (let e = 0; e < a.length; e++) {
        let t = a[e];
        for (let e = t.start; e <= t.end; e++) ml(i, o[e], s);
    }
    return new Bc({ points: i, options: {} });
}
function pl(e, t) {
    let n = [],
...
function ml(e, t, n) {
    ...
    for (let i = 0; i < n.length; i++) {
        let a = n[i],
            { first: o, last: s, point: c } = hl(a, t, `x`);
        if (!(!c || (o && s))) {
            if (o) r.unshift(c);
...
function _l(e) {
    ...
    if (B(n)) return vl(t, n);
    if (n === `stack`) return fl(e);
    if (n === `shape`) return !0;
    let i = yl(e);
    return i instanceof gl ? i : il(i, r);
}
function vl(e, t) {
...
function yl(e) {
    return (e.scale || {}).getPointPositionForValue ? xl(e) : bl(e);
}
function bl(e) {
    ...
    (a !== i &&
        (l === `x`
            ...
            : l === `y` &&
              ...
              Tl(e, r, o.right),
              (u = i))),
        El(e, { line: n, target: r, color: u, scale: s, property: l, clip: c }),
        e.restore());
}
function wl(e, t, n) {
...
var kl = {
        ...
        afterDatasetsUpdate(e, t, n) {
            ...
            for (o = 0; o < r; ++o)
                ((c = i[o]),
                    !(!c || c.fill === !1) && (c.fill = ol(i, o, n.propagate)));
        },
        beforeDraw(e, t, n) {
    ...
    Ml = class extends vs {
        ...
        buildLabels() {
            let e = this.options.labels || {},
                t = U(e.generateLabels, [this.chart], this) || [];
        ...
        fit() {
            ...
            let n = e.labels,
                ...
                { boxWidth: o, itemHeight: s } = Al(n, i),
                c,
                l;
            ((t.font = r.string),
                this.isHorizontal()
                    ? ((c = this.maxWidth),
                      (l = this._fitRows(a, i, o, s) + 10))
                    : ((l = this.maxHeight),
                      (c = this._fitCols(a, r, o, s) + 10)),
        ...
        _fitCols(e, t, n, r) {
            ...
            return (
                this.legendItems.forEach((e, a) => {
                    let { itemWidth: h, itemHeight: g } = Nl(n, t, i, e, r);
                    (a > 0 &&
                        f + g + 2 * o > l &&
                        ((u += d + o),
        ...
        adjustHitBoxes() {
            ...
            let e = this._computeTitleHeight(),
                ...
                a = fa(i, this.left, this.width);
            if (this.isHorizontal()) {
                let i = 0,
                    o = J(n, this.left + r, this.right - this.lineWidths[i]);
                for (let s of t)
                    (i !== s.row &&
                        ((i = s.row),
                        (o = J(
        ...
        _draw() {
            let { options: e, columnSizes: t, lineWidths: n, ctx: r } = this,
                { align: i, labels: a } = e,
                o = Y.color,
                s = fa(e.rtl, this.left, this.width),
                c = Z(a.font),
                { padding: l } = a,
                u = c.size,
                d = u / 2,
            ...
            (this.drawTitle(),
                ...
                (r.lineWidth = 0.5),
                (r.font = c.string));
            let { boxWidth: p, boxHeight: m, itemHeight: h } = Al(a, u),
                g = function (e, t, n) {
                    if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return;
                    r.save();
                    let i = H(n.lineWidth, 1);
                    if (
                        ((r.fillStyle = H(n.fillStyle, o)),
                        (r.lineCap = H(n.lineCap, `butt`)),
                        (r.lineDashOffset = H(n.lineDashOffset, 0)),
                        (r.lineJoin = H(n.lineJoin, `miter`)),
                        (r.lineWidth = i),
                        (r.strokeStyle = H(n.strokeStyle, o)),
                        r.setLineDash(H(n.lineDash, [])),
                        a.usePointStyle)
                    ) {
                        let o = {
                            ...
                            c = s.xPlus(e, p / 2),
                            l = t + d;
                        Yr(r, o, c, l, a.pointStyleWidth && p);
                    } else {
            ...
            ((f = v
                ? {
                      x: J(i, this.left + l, this.right - n[0]),
                      y: this.top + l + y,
                      line: 0,
                  }
                : {
                      x: this.left + l,
                      y: J(i, this.top + y + l, this.bottom - t[0].height),
                      line: 0,
                  }),
                pa(this.ctx, e.textDirection));
            let b = h + l;
            (this.legendItems.forEach((o, u) => {
                ...
                (s.setWidth(this.width),
                    v
                        ? u > 0 &&
                          ...
                          f.line++,
                          (S = f.x =
                              J(i, this.left + l, this.right - n[f.line])))
                        : u > 0 &&
                          C + b > this.bottom &&
                ...
                if (
                    (g(w, C, o),
                    (S = vr(h, S + p + d, v ? S + x : this.right, e.rtl)),
                    _(s.x(S), C, o),
                    v)
                )
                    f.x += x + l;
        ...
        drawTitle() {
            let e = this.options,
                ...
                r = X(t.padding);
            if (!t.display) return;
            let i = fa(e.rtl, this.left, this.width),
                a = this.ctx,
                o = t.position,
                s = n.size / 2,
                c = r.top + s,
            ...
            if (this.isHorizontal())
                ((d = Math.max(...this.lineWidths)),
                    (l = this.top + c),
                    (u = J(e.align, u, this.right - d)));
            else {
                let t = this.columnSizes.reduce(
        ...
        _getLegendItemAt(e, t) {
            let n, r, i;
            if (ar(e, this.left, this.right) && ar(t, this.top, this.bottom)) {
                for (i = this.legendHitBoxes, n = 0; n < i.length; ++n)
                    if (
                        ((r = i[n]),
                        ar(e, r.left, r.left + r.width) &&
                            ar(t, r.top, r.top + r.height))
                    )
        ...
        handleEvent(e) {
            let t = this.options;
            if (!Ll(e.type, t)) return;
            let n = this._getLegendItemAt(e.x, e.y);
            if (e.type === `mousemove` || e.type === `mouseout`) {
                let r = this._hoveredItem,
                    i = jl(r, n);
                (r && !i && U(t.onLeave, [e, r, this], this),
                    (this._hoveredItem = n),
                    n && !i && U(t.onHover, [e, n, this], this));
            } else n && U(t.onClick, [e, n, this], this);
        }
    };
function Nl(e, t, n, r, i) {
    return { itemWidth: Pl(r, e, t, n), itemHeight: Fl(i, r, t.lineHeight) };
}
function Pl(e, t, n, r) {
    let i = e.text;
    return (
...
function Fl(e, t, n) {
    let r = e;
    return (typeof t.text != `string` && (r = Il(t, n)), r);
}
function Il(e, t) {
...
var Rl = {
        ...
        _element: Ml,
        start(e, t, n) {
            let r = (e.legend = new Ml({ ctx: e.ctx, options: n, chart: e }));
            (Jo.configure(e, r, n), Jo.addBox(e, r));
        },
        stop(e) {
            (Jo.removeBox(e, e.legend), delete e.legend);
        },
        beforeUpdate(e, t, n) {
            let r = e.legend;
            (Jo.configure(e, r, n), (r.options = n));
        },
        afterUpdate(e) {
            let t = e.legend;
    ...
    zl = class extends vs {
        ...
        update(e, t) {
            ...
            let r = R(n.text) ? n.text.length : 1;
            this._padding = X(n.padding);
            let i = r * Z(n.font).lineHeight + this._padding.height;
        ...
        _drawArgs(e) {
            let { top: t, left: n, bottom: r, right: i, options: a } = this,
                o = a.align,
                s = 0,
                c,
                l,
            ...
            return (
                this.isHorizontal()
                    ? ((l = J(o, n, i)), (u = t + e), (c = i - n))
                    : (a.position === `left`
                          ? ((l = n + e), (u = J(o, r, t)), (s = G * -0.5))
                          : ((l = i - e), (u = J(o, t, r)), (s = G * 0.5)),
                      (c = r - t)),
                { titleX: l, titleY: u, maxWidth: c, rotation: s }
            );
        }
        draw() {
            let e = this.ctx,
...
function Bl(e, t) {
    let n = new zl({ ctx: e.ctx, options: t, chart: e });
    (Jo.configure(e, n, t), Jo.addBox(e, n), (e.titleBlock = n));
}
var Vl = {
        id: `title`,
        _element: zl,
        ...
        stop(e) {
            let t = e.titleBlock;
            (Jo.removeBox(e, t), delete e.titleBlock);
        },
        beforeUpdate(e, t, n) {
            let r = e.titleBlock;
            (Jo.configure(e, r, n), (r.options = n));
...
function Kl(e, t) {
    ...
    f &&
        (h += t.footerMarginTop + f * u.lineHeight + (f - 1) * t.footerSpacing);
    let v = 0,
        y = function (e) {
    ...
    return (
        ...
        W(e.title, y),
        (n.font = c.string),
        W(e.beforeBody.concat(e.afterBody), y),
        (v = t.displayColors ? o + 2 + t.boxPadding : 0),
        W(r, (e) => {
            (W(e.before, y), W(e.lines, y), W(e.after, y));
        }),
        (v = 0),
        (n.font = u.string),
        W(e.footer, y),
...
function Xl(e, t, n) {
    let r = n.yAlign || t.yAlign || ql(e, n);
    return { xAlign: n.xAlign || t.xAlign || Yl(e, t, n, r), yAlign: r };
}
function Zl(e, t) {
    let { x: n, width: r } = e;
...
function $l(e, t, n, r) {
    let { caretSize: i, caretPadding: a, cornerRadius: o } = e,
        { xAlign: s, yAlign: c } = n,
        l = i + a,
        { topLeft: u, topRight: d, bottomLeft: f, bottomRight: p } = fi(o),
        m = Zl(t, s),
        h = Ql(t, c, l);
    return (
        c === `center`
        ...
        { x: rr(m, 0, r.width - t.width), y: rr(h, 0, r.height - t.height) }
    );
}
function eu(e, t, n) {
    let r = X(n.padding);
...
function nu(e, t, n) {
    return hi(e, { tooltip: t, tooltipItems: n, type: `tooltip` });
}
function ru(e, t) {
...
function Q(e, t, n, r) {
    let i = e[t].call(n, r);
    return i === void 0 ? iu[t].call(n, r) : i;
}
var au = class extends vs {
        static positioners = Hl;
        constructor(e) {
            (super(),
                (this.opacity = 0),
                (this._active = []),
        ...
        _resolveAnimations() {
            ...
            let t = this.chart,
                ...
                i = new Pa(this.chart, r);
            return (
                r._cacheable && (this._cachedAnimations = Object.freeze(i)),
                i
            );
        }
        getContext() {
        ...
        getBeforeBody(e, t) {
            return tu(Q(t.callbacks, `beforeBody`, this, e));
        }
        getBody(e, t) {
            let { callbacks: n } = t,
                r = [];
            return (
                W(e, (e) => {
                    let t = { before: [], lines: [], after: [] },
                        i = ru(n, e);
                    (Ul(t.before, Wl(Q(i, `beforeLabel`, this, e))),
                        Ul(t.lines, Q(i, `label`, this, e)),
                        Ul(t.after, Wl(Q(i, `afterLabel`, this, e))),
                        r.push(t));
                }),
                r
            );
        ...
        getAfterBody(e, t) {
            return tu(Q(t.callbacks, `afterBody`, this, e));
        }
        getFooter(e, t) {
            let { callbacks: n } = t,
        ...
        update(e, t) {
            ...
            if (!r.length) this.opacity !== 0 && (i = { opacity: 0 });
                ...
                let e = Hl[n.position].call(this, r, this._eventPosition);
                ...
                let t = (this._size = Kl(this, n)),
                    o = Object.assign({}, e, t),
                    s = Xl(this.chart, n, o),
                    c = $l(n, o, s, this.chart);
        ...
        drawTitle(e, t, n) {
            let r = this.title,
                ...
                s;
            if (i) {
                let c = fa(n.rtl, this.x, this.width);
                for (
                    e.x = eu(this, n.titleAlign, n),
        ...
        _drawColorBox(e, t, n, r, i) {
            ...
            if (i.usePointStyle) {
                ...
                Object.values(o).some((e) => e !== 0)
                    ? (e.beginPath(),
                      (e.fillStyle = i.multiKeyBackground),
                      ai(e, { x: t, y: p, w: c, h: s, radius: o }),
                      e.fill(),
                      e.stroke(),
                      (e.fillStyle = a.backgroundColor),
                      e.beginPath(),
                      ai(e, { x: n, y: p + 1, w: c - 2, h: s - 2, radius: o }),
                      e.fill())
                    : ((e.fillStyle = i.multiKeyBackground),
                      e.fillRect(t, p, c, s),
        ...
        drawBody(e, t, n) {
            ...
            ((f = 0), (d = u.lineHeight), W(this.afterBody, m), (e.y -= i));
        }
        drawFooter(e, t, n) {
            let r = this.footer,
                i = r.length,
                ...
                o;
            if (i) {
                let s = fa(n.rtl, this.x, this.width);
                for (
                    e.x = eu(this, n.footerAlign, n),
        ...
        _updateAnimationTarget(e) {
            let t = this.chart,
                ...
                i = n && n.y;
            if (r || i) {
                let n = Hl[e.position].call(
                    this,
                    this._active,
                    this._eventPosition,
                );
                if (!n) return;
                let a = (this._size = Kl(this, e)),
    ...
    ou = {
        ...
        positioners: Hl,
        afterInit(e, t, n) {
            n && (e.tooltip = new au({ chart: e, options: n }));
        },
        beforeUpdate(e, t, n) {
        ...
        afterDraw(e) {
            ...
            if (t && t._willRender()) {
                let n = { tooltip: t };
                if (
                    e.notifyPlugins(`beforeTooltipDraw`, {
                        ...n,
                        cancelable: !0,
                    }) === !1
                )
...
function cu(e, t, n, r) {
    let i = e.indexOf(t);
    return i === -1 ? su(e, t, n, r) : i === e.lastIndexOf(t) ? i : n;
}
var lu = (e, t) => (e === null ? null : rr(Math.round(e), 0, t));
function uu(e) {
    let t = this.getLabels();
    return e >= 0 && e < t.length ? t[e] : e;
}
var du = class extends Rs {
    static id = `category`;
    static defaults = { ticks: { callback: uu } };
    constructor(e) {
        (super(e),
    ...
    parse(e, t) {
        ...
        return (
            (t =
                isFinite(t) && n[t] === e
                    ? t
                    : cu(n, e, H(t, e), this._addedLabels)),
            lu(t, n.length - 1)
        );
    }
    determineDataLimits() {
...
function fu(e, t) {
    ...
    ((w = Math.ceil(h / b) - Math.floor(m / b)),
        w > p && (b = Un((w * b) / p / f) * f),
        L(s) || ((x = 10 ** s), (b = Math.ceil(b * x) / x)),
        r === `ticks`
            ? ((S = Math.floor(m / b) * b), (C = Math.ceil(h / b) * b))
            : ((S = m), (C = h)),
        g && _ && i && qn((o - a) / i, b / 1e3)
            ...
            : v
              ? ((S = g ? a : S),
                ...
                (b = (C - S) / w))
              : ((w = (C - S) / b),
                (w = Hn(w, Math.round(w), b / 1e3)
                    ? Math.round(w)
                    : Math.ceil(w))));
    let T = Math.max(Zn(b), Zn(S));
    ((x = 10 ** (L(s) ? T : s)),
        (S = Math.round(S * x) / x),
        (C = Math.round(C * x) / x));
    let E = 0;
    for (
        ...
        (d && S !== a
            ? (n.push({ value: a }),
              S < a && E++,
              Hn(Math.round((S + E * b) * x) / x, a, pu(a, y, e)) && E++)
            : S < a && E++);
        E < w;
        ++E
    ) {
    ...
    return (
        _ && d && C !== o
            ? n.length && Hn(n[n.length - 1].value, o, pu(o, y, e))
...
function pu(e, t, { horizontal: n, minRotation: r }) {
    let i = Yn(r),
        a = (n ? Math.sin(i) : Math.cos(i)) || 0.001,
        o = 0.75 * t * (`` + e).length;
    return Math.min(t / a, o);
}
var mu = class extends Rs {
        constructor(e) {
            (super(e),
                (this.start = void 0),
                (this.end = void 0),
        ...
        getTickLimit() {
            ...
            return (
                t
                    ? ((n =
                          Math.ceil(this.max / t) -
                          Math.floor(this.min / t) +
                          1),
                      n > 1e3 &&
                          (console.warn(
        ...
        buildTicks() {
            ...
            return (
                e.bounds === `ticks` && Jn(r, this, `value`),
                e.reverse
                    ? (r.reverse(),
                      (this.start = this.max),
                      (this.end = this.min))
    ...
    hu = class extends mu {
        static id = `linear`;
        static defaults = { ticks: { callback: Lr.formatters.numeric } };
        determineDataLimits() {
        ...
        computeTickLimit() {
            let e = this.isHorizontal(),
                ...
                n = Yn(this.options.ticks.minRotation),
...
function bu(e, t) {
    ...
    for (; yu(e, t, n) > 10;) n++;
    for (; yu(e, t, n) < 10;) n--;
    return Math.min(n, gu(e));
}
function xu(e, { min: t, max: n }) {
    t = V(e.min, t);
    let r = [],
        i = gu(t),
        a = bu(t, n),
        ...
        f = V(e.min, Math.round((c + u + d * 10 ** a) * o) / o);
    for (; f < n;)
        (r.push({ value: f, major: vu(f), significand: d }),
            d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
            d >= 20 && (a++, (d = 2), (o = a >= 0 ? 1 : o)),
            (f = Math.round((c + u + d * 10 ** a) * o) / o));
    let p = V(e.max, f);
    return (r.push({ value: p, major: vu(p), significand: d }), r);
}
(class extends Rs {
    ...
    parse(e, t) {
        let n = mu.prototype.parse.apply(this, [e, t]);
        if (n === 0) {
            this._zero = !0;
            return;
        }
    ...
    determineDataLimits() {
        let { min: e, max: t } = this.getMinMax(!0);
        ((this.min = B(e) ? Math.max(0, e) : null),
            (this.max = B(t) ? Math.max(0, t) : null),
            this.options.beginAtZero && (this._zero = !0),
            this._zero &&
                this.min !== this._suggestedMin &&
                !B(this._userMin) &&
                (this.min =
                    e === _u(this.min, 0) ? _u(this.min, -1) : _u(this.min, 0)),
            this.handleTickRangeOptions());
    }
    handleTickRangeOptions() {
        let { minDefined: e, maxDefined: t } = this.getUserBounds(),
            ...
            i = (t) => (n = e ? n : t),
            a = (e) => (r = t ? r : e);
        (n === r && (n <= 0 ? (i(1), a(10)) : (i(_u(n, -1)), a(_u(r, 1)))),
            n <= 0 && i(_u(r, -1)),
            r <= 0 && a(_u(n, 1)),
            (this.min = n),
            (this.max = r));
    ...
    buildTicks() {
        let e = this.options,
            t = xu({ min: this._userMin, max: this._userMax }, this);
        return (
            e.bounds === `ticks` && Jn(t, this, `value`),
            e.reverse
    ...
    getLabelForValue(e) {
        return e === void 0
            ? `0`
            : Pr(e, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
        let e = this.min;
        (super.configure(),
            (this._startValue = Bn(e)),
            (this._valueRange = Bn(this.max) - Bn(e)));
    }
    getPixelForValue(e) {
        return (
            ...
            e === null || isNaN(e)
                ...
                : this.getPixelForDecimal(
                      e === this.min
                          ? 0
                          : (Bn(e) - this._startValue) / this._valueRange,
                  )
        );
    }
    getValueForPixel(e) {
...
function Su(e) {
    ...
    if (t.display && e.display) {
        ...
        return H(t.font && t.font.size, Y.font.size) + e.height;
    }
    return 0;
}
function Cu(e, t, n) {
    return (
        (n = R(n) ? n : [n]),
        { w: Gr(e, t.string, n), h: n.length * t.lineHeight }
    );
}
...
function ku(e, t, n) {
    let r = [],
        ...
        c = { extra: Su(a) / 2, additionalAngle: o ? G / i : 0 },
        l;
    for (let a = 0; a < i; a++) {
        ((c.padding = n[a]), (c.size = t[a]));
        let i = Du(e, a, c);
        (r.push(i),
            s === `auto` && ((i.visible = Ou(i, l)), i.visible && (l = i)));
    }
    return r;
}
function Au(e) {
...
function Pu(e, t) {
    ...
    for (let i = t - 1; i >= 0; i--) {
        ...
        ii(n, e._pointLabels[i], s, c + o.lineHeight / 2, o, {
            color: a.color,
            textAlign: l,
            textBaseline: `middle`,
        });
...
function Fu(e, t, n, r) {
    let { ctx: i } = e;
    if (n) i.arc(e.xCenter, e.yCenter, t, 0, K);
    else {
...
function Lu(e, t, n) {
    return hi(e, { label: n, index: t, type: `pointLabel` });
}
(class extends mu {
    ...
    setDimensions() {
        let e = (this._padding = X(Su(this.options) / 2)),
    ...
    determineDataLimits() {
        ...
        ((this.min = B(e) && !isNaN(e) ? e : 0),
            (this.max = B(t) && !isNaN(t) ? t : 0),
            this.handleTickRangeOptions());
    }
    computeTickLimit() {
    ...
    generateTickLabels(e) {
        (mu.prototype.generateTickLabels.call(this, e),
            (this._pointLabels = this.getLabels()
                .map((e, t) => {
                    let n = U(this.options.pointLabels.callback, [e, t], this);
                    return n || n === 0 ? n : ``;
                })
    ...
    getIndexAngle(e) {
        let t = K / (this._pointLabels.length || 1),
    ...
    getPointPosition(e, t, n = 0) {
        let r = this.getIndexAngle(e) - q + n;
        return {
    ...
    drawGrid() {
        let e = this.ctx,
            ...
            c;
        if (
            (t.pointLabels.display && Pu(this, a),
            r.display &&
...
function Bu(e, t) {
    ...
    return (
        ...
        B(o) || (o = typeof r == `string` ? n.parse(o, r) : n.parse(o)),
        o === null
            ? null
            : (i &&
                  (o =
...
function Hu(e, t, n, r, i) {
    for (let a = $.length - 1; a >= $.indexOf(n); a--) {
        let n = $[a];
        if (Ru[n].common && e._adapter.diff(i, r, n) >= t - 1) return n;
    }
    return $[n ? $.indexOf(n) : 0];
}
function Uu(e) {
    for (let t = $.indexOf(e) + 1, n = $.length; t < n; ++t)
        if (Ru[$[t]].common) return $[t];
}
function Wu(e, t, n) {
    if (!n) e[t] = !0;
    else if (n.length) {
        let { lo: r, hi: i } = or(n, t),
            a = n[r] >= t ? n[r] : n[i];
        e[a] = !0;
    }
}
...
function Ku(e, t, n) {
    ...
    return a === 0 || !n ? r : Gu(e, r, i, n);
}
var qu = class extends Rs {
    static id = `time`;
    static defaults = {
        bounds: `data`,
        adapters: {},
    ...
    init(e, t = {}) {
        let n = (e.time ||= {}),
            r = (this._adapter = new So._date(e.adapters.date));
        (r.init(t),
            wn(n.displayFormats, r.formats()),
            (this._parseOpts = {
                parser: n.parser,
                round: n.round,
    ...
    parse(e, t) {
        return e === void 0 ? null : Bu(this, e);
    }
    beforeLayout() {
        (super.beforeLayout(),
            (this._cache = { data: [], labels: [], all: [] }));
    ...
    determineDataLimits() {
        ...
        ((!a || !o) &&
            ...
            (e.bounds !== `ticks` || e.ticks.source !== `labels`) &&
                s(this.getMinMax(!1))),
            (r = B(r) && !isNaN(r) ? r : +t.startOf(Date.now(), n)),
            (i = B(i) && !isNaN(i) ? i : +t.endOf(Date.now(), n) + 1),
        ...
        return (
            (this._unit =
                ...
                (n.autoSkip
                    ...
                    : Hu(this, o.length, t.minUnit, this.min, this.max))),
            (this._majorUnit =
    ...
    initOffsets(e = []) {
        ...
        this.options.offset &&
            ...
            (t =
                e.length === 1
                    ? 1 - r
                    : (this.getDecimalForValue(e[1]) - r) / 2),
    ...
    _generate() {
        let e = this._adapter,
            ...
            r = this.options,
            i = r.time,
            a = i.unit || Vu(i.minUnit, t, n, this._getLabelCapacity(t)),
            o = H(r.ticks.stepSize, 1),
            s = a === `week` && i.isoWeekday,
            c = Kn(s) || s === !0,
            l = {},
            u = t,
            d,
        ...
        for (d = u, f = 0; d < n; d = +e.add(d, o, a), f++) Wu(l, d, p);
        return (
            (d === n || r.bounds === `ticks` || f === 1) && Wu(l, d, p),
            Object.keys(l)
                .sort(zu)
                .map((e) => +e)
        );
    ...
    _getLabelSize(e) {
        let t = this.options.ticks,
            ...
            r = Yn(this.isHorizontal() ? t.maxRotation : t.minRotation),
            i = Math.cos(r),
            a = Math.sin(r),
    ...
    getLabelTimestamps() {
        ...
        for (t = 0, n = r.length; t < n; ++t) e.push(Bu(this, r[t]));
...
function Ju(e, t, n) {
    ...
    n
        ? (t >= e[r].pos &&
              t <= e[i].pos &&
              ({ lo: r, hi: i } = sr(e, `pos`, t)),
          ({ pos: a, time: s } = e[r]),
          ({ pos: o, time: c } = e[i]))
        : (t >= e[r].time &&
              t <= e[i].time &&
              ({ lo: r, hi: i } = sr(e, `time`, t)),
          ({ time: a, pos: s } = e[r]),
          ({ time: o, pos: c } = e[i]));
    let l = o - a;
...
(class extends qu {
    ...
    initOffsets() {
        ...
        ((this._minPos = Ju(t, this.min)),
            (this._tableRange = Ju(t, this.max) - this._minPos),
            super.initOffsets(e));
    }
    buildLookupTable(e) {
    ...
    getDecimalForValue(e) {
        return (Ju(this._table, e) - this._minPos) / this._tableRange;
    }
    getValueForPixel(e) {
        let t = this._offsets,
            n = this.getDecimalForPixel(e) / t.factor - t.end;
        return Ju(this._table, n * this._tableRange + this._minPos, !0);
    }
});
var Yu = {
    ...
    Xu = { ariaLabel: { type: String }, ariaDescribedby: { type: String } },
    Zu = {
    ...
    Qu = (e, t) => Object.assign(e, t);
function $u(e) {
    return u(e) ? h(e) : e;
}
function ed(e) {
    return u(arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : e)
        ? new Proxy(e, {})
        : e;
}
function td(e, t) {
...
function id(e, t) {
    ...
    return (nd(n, e.labels), rd(n, e.datasets, t), n);
}
var ad = O({
    props: Zu,
    setup(e, t) {
                ...
                (t, n) => {
                    ...
                    if (i) {
                        let t = $u(i.labels),
                            ...
                            r = $u(i.datasets),
                            a = $u(c.datasets);
                        (t !== n && (nd(u.config.data, t), (d = !0)),
                            r &&
                                r !== a &&
                                (rd(u.config.data, r, e.datasetIdKey),
                                (d = !0)));
                    }
                    d &&
                        o(() => {
...
var sd = od(`bar`, yo),
    ...
    ld = O({
        ...
        props: {
            ...
            selectionBehavior: {},
            highlightOnHover: { type: Boolean, default: !0 },
            by: {},
        ...
        setup(e, { emit: t }) {
            let n = e,
                ...
                o = P(new Map()),
                s = P(new Map()),
                { contains: c } = Ze({ sensitivity: `base` }),
                u = l({
                    search: ``,
            ...
            function d() {
                if (!u.search) {
                    u.filtered.count = o.value.size;
                    return;
                }
                u.filtered.groups = new Set();
                let e = 0;
                for (let [t, n] of o.value) {
                    let r = c(n, u.search);
                    (u.filtered.items.set(t, +!!r), r && e++);
                }
                for (let [e, t] of s.value)
                    for (let n of t)
                        if (u.filtered.items.get(n) > 0) {
                            u.filtered.groups.add(e);
                            break;
                        }
                u.filtered.count = e;
            }
            return (
                ...
                vd({ allItems: o, allGroups: s, filterState: u }),
                (e, t) => (
                    v(),
                    N(
                        F(rt),
                        A({ 'data-slot': `command` }, F(a), {
                            class: F(oe)(
    ...
    ud = O({
        ...
        setup(e) {
            let t = e,
                n = ce(t, `class`),
                { filterState: r } = _d(),
                i = c(() => !!r.search && r.filtered.count === 0);
            return (e, r) =>
                i.value
                    ? (v(),
                      N(
                          F(ae),
                          A({ key: 0, 'data-slot': `command-empty` }, F(n), {
                              class: F(oe)(`py-6 text-center text-sm`, t.class),
                          }),
                          { default: g(() => [x(e.$slots, `default`)]), _: 3 },
                          16,
                          [`class`],
    ...
    dd = O({
        ...
        setup(e) {
            let t = e,
                r = ce(t, `class`),
                { allGroups: i, filterState: a } = _d(),
                o = n(),
                s = c(() => !a.search || a.filtered.groups.has(o));
            return (
                bd({ id: o }),
                p(() => {
                    i.value.has(o) || i.value.set(o, new Set());
                }),
                y(() => {
                    i.value.delete(o);
                }),
    ...
    pd = O({
        ...
        setup(t) {
            ...
            return (e, t) => (
                v(),
                S(`div`, fd, [
                    M(F(Ct), { class: `size-4 shrink-0 opacity-50` }),
                    M(
                        F(at),
                        A(
                            { ...F(r), ...e.$attrs },
                            {
                                modelValue: F(i).search,
    ...
    md = O({
        ...
        setup(e, { emit: t }) {
            let i = e,
                ...
                o = r(ce(i, `class`), a),
                s = n(),
                { filterState: l, allItems: u, allGroups: f } = _d(),
                m = yd(),
                h = c(() => {
                    if (l.search) {
                        let e = l.filtered.items.get(s);
                        return e === void 0 || e > 0;
                    } else return !0;
                }),
                _ = P(),
            ...
            return (
                p(() => {
                    ...
                    u.value.set(
                        s,
                        b.value.textContent ?? i.value?.toString() ?? ``,
                    );
                    let e = m?.id;
                    e &&
                        (f.value.has(e)
                            ? f.value.get(e)?.add(s)
                            : f.value.set(e, new Set([s])));
                }),
                y(() => {
                    u.value.delete(s);
                }),
    ...
    xd = O({
        ...
        setup(e, { emit: t }) {
            ...
            return (e, t) => (
                ...
                N(
                    F(gt),
                    A({ 'data-slot': `popover` }, F(n)),
                    {
                        default: g((t) => [x(e.$slots, `default`, ie(te(t)))]),
                        _: 3,
                    },
                    16,
                )
    ...
    wd = { class: `space-y-1.5` },
    Td = { class: `text-muted-foreground` },
    Ed = { key: 0, class: `flex flex-wrap gap-1` },
    Dd = [`onClick`],
    Od = O({
        __name: `MultiSelectCombobox`,
        ...
        setup(e, { emit: t }) {
            let n = e,
                ...
                i = P(!1),
                a = c(() =>
                    n.options.filter((e) => n.modelValue.includes(e.id)),
                );
            function o(e) {
                let t = n.modelValue.includes(e)
                    ? n.modelValue.filter((t) => t !== e)
                    : [...n.modelValue, e];
                                            ...
                                            M(F(ld), null, {
                                                default: g(() => [
                                                    M(
                                                        F(pd),
                                                        {
                                                            placeholder: `Search ${e.placeholder?.toLowerCase() ?? `options`}...`,
                                                        },
                                                        null,
                                                        8,
                                                        [`placeholder`],
    ...
    Ad = { class: `grid gap-4 md:grid-cols-4` },
    jd = { class: `flex flex-wrap items-center gap-3` },
    Md = { class: `h-64` },
    Nd = { class: `grid gap-4 md:grid-cols-2` },
    Pd = { class: `h-64` },
    Fd = { class: `h-64` },
    Id = { class: `h-64` },
    Ld = O({
        layout: { breadcrumbs: [{ title: `Dashboard`, href: Ue() }] },
        __name: `Dashboard`,
        props: {
            summary: {},
            dailyTotals: {},
        ...
        setup(e) {
            Ec.register(Vl, ou, Rl, Qc, Bc, Hc, du, hu, kl);
            let t = e,
                n = P(t.range ?? `30`),
                r = P(t.filters.language_ids ?? []),
                i = P(t.filters.modality_ids ?? []),
                a = P(t.filters.input_source_ids ?? []);
            w([r, i, a, n], h, { deep: !0 });
            function o(e) {
                return `${Math.floor(e / 3600)}h ${Math.floor((e % 3600) / 60)}m`;
            }
            function l(e) {
            ...
            let u = c(() => ({
                    labels: t.dailyTotals.map((e) => l(e.date)),
                    datasets: [
                        {
                            label: `Minutes`,
                            data: t.dailyTotals.map((e) =>
            ...
            function p(e) {
                return {
                    ...
                    datasets: [
                        {
                            label: `Minutes`,
                            data: e.map((e) => Math.round(e.seconds / 60)),
            ...
            let m = {
                ...
                maintainAspectRatio: !1,
                plugins: { legend: { display: !1 } },
                scales: { x: { beginAtZero: !0, ticks: { precision: 0 } } },
            };
            function h() {
                E.get(
                    `/dashboard`,
                    {
                        language_ids: r.value,
                        modality_ids: i.value,
                        input_source_ids: a.value,
                        range: n.value,
                    },
            ...
            function _() {
                ((r.value = []), (i.value = []), (a.value = []), h());
            }
            function y(e, t) {
                let n = new Date(e + `T00:00:00`),
                    r = new Date(t[0] + `T00:00:00`);
                return (new Date(t[t.length - 1] + `T00:00:00`).getTime() -
                    r.getTime()) /
                    (1e3 * 60 * 60 * 24) >
                    365
            ...
            let b = c(() => {
                    let e = t.growth.map((e) => e.date);
                    return {
                        labels: e.map((t) => y(t, e)),
                        datasets: [
                            {

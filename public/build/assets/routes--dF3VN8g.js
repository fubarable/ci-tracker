import { n as e } from './wayfinder-Dp7PqxvV.js';
var t = (e) => ({ url: t.url(e), method: `get` });
((t.definition = { methods: [`get`, `head`], url: `/login` }),
    (t.url = (n) => t.definition.url + e(n)),
    (t.get = (e) => ({ url: t.url(e), method: `get` })),
    (t.head = (e) => ({ url: t.url(e), method: `head` })));
var n = (e) => ({ action: t.url(e), method: `get` });
((n.get = (e) => ({ action: t.url(e), method: `get` })),
    (n.head = (e) => ({
        action: t.url({
...
((s.definition = { methods: [`get`, `head`], url: `/dashboard` }),
    (s.url = (t) => s.definition.url + e(t)),
    (s.get = (e) => ({ url: s.url(e), method: `get` })),
    (s.head = (e) => ({ url: s.url(e), method: `head` })));
var c = (e) => ({ action: s.url(e), method: `get` });
((c.get = (e) => ({ action: s.url(e), method: `get` })),
    (c.head = (e) => ({
        action: s.url({
            [e?.mergeQuery ? `mergeQuery` : `query`]: {
                _method: `HEAD`,
    ...
    (s.form = c));
export { r as i, a as n, t as r, s as t };

import { G as e, tr as t } from './dist-BjNOdvyx.js';
import { i as n } from './useForwardExpose-JHVakd1j.js';
import { t as r } from './createLucideIcon-DhBKMkeN.js';
function i(e) {
    return typeof e == `string` ? `'${e}'` : new a().serialize(e);
}
var a = (function () {
    class e {
        #e = new Map();
        ...
        serializeObject(e) {
            ...
            if (r !== `` && globalThis[r] === n)
                return this.serializeBuiltInType(r, e);
        ...
        serializeObjectEntries(e, t) {
            ...
            for (let e = 0; e < n.length; e++) {
                let [t, i] = n[e];
                ((r += `${this.serialize(t, !0)}:${this.serialize(i)}`),
                    e < n.length - 1 && (r += `,`));
            }
            return r + `}`;
        }
        ...
        $Array(e) {
            ...
            for (let n = 0; n < e.length; n++)
                ((t += this.serialize(e[n])), n < e.length - 1 && (t += `,`));
            return t + `]`;
        }
        $Date(e) {
            try {
    ...
    for (let t of [`BigInt64Array`, `BigUint64Array`])
        e.prototype[`$` + t] = function (e) {
...
function s(r) {
    return e(() => !t(r) || !!n(r)?.closest(`form`));
}
var c = r(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]);
